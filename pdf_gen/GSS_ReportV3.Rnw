...
if (runtype == 1)
{
    ...
    if(lang == "in")
    {
       ...
       rowwidth1<-round(3.9/nrow(data1),5)
    }
                ...
                for (rs in 1:tmax)
                {
                     if (sorteddata_trait[rs,3] != "0" )
                     {
                         if((nrow(data3)+count) < 9) {                       
                            cat("\\rowcolor{rowcol}","\n")     
                            if ((nrow(data1) != 0 || nrow(data2) != 0) && nrow(sorteddata) < 7) {
                            tnflag<-1            
...
if (xmlSize(diseases) !=0)
{
    ...
    {       
         ...
         if (traitflag == 'N') {  
             ...
             if (lang =="in") {
                 cat(paste("\\parbox[t][1.7cm]{1.35cm}{\\textbf{",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", GLR,"\\%}}\\\\",sep=""),"\n")
                 cat("\\hline","\n")
                 cat("\\rowcolor{rowcol}","\n") 
                 cat(paste("\\parbox[t][1.7cm]{1.35cm}{\\textbf{",TblGenetic_row2_title,"}}  & \\textbf{\\textcolor{black}{",AvGLR,"\\%}}\\\\",sep=""),"\n")
             } else {
             ...
             if (lang == "in") {
                 cat(paste("\\textbf{\\textcolor{white}{",TblGenetic_col3_title,"}}\\\\[.34cm]",sep=""),"\n")
             } else { 
             ...
             if (file.exists(ImageFile)) {
                 ...
                 if (lang == "in") {
                     cat(paste("\\includegraphics[trim=0.21cm 2.5cm 0cm 0.3cm, clip=true,width=0.82\\linewidth]{",ImageFile,"}",sep=""),"\n")
                 } else {
         ...
         if (Text != ""){    
             ...
             if ((lang == "en") && (disid=="PDC_01_03" || disid=="CRD_01_05")) {
                 ...
                 if ((lang == "en") && ((disid=="ONC_01_03" && PatientGender == "M") || ( disid=="ONC_01_04" && PatientGender == "M") || 
                     ...
                     if ((lang=="en") && (disid=="ONC_01_07")) { cat("~\\\\","\n") } 
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 }   
                 ...
                 cat("~\\\\","\n")
                 cat("~\\\\[10pt]","\n")  
             } else if ((lang == "in") && (disid=="CRD_01_08")){ 
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\","\n")
...
################################### Disease's Prevention ###################
         ...
         if (disid=="MTB_01_09") #|| disid=="ONC_01_30") 
         {
             Text_Tmp<-""             
         }   
...
#}
         ...
         if (ChipType == "CRD"){  
             ...
             if ((lang == "en") && (disid=="MTB_01_11" || disid=="MTB_01_08")) {
                 ...
                 cat("~\\\\[-4pt]","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="MTB_01_11")){
                 cat("\\newpage","\n")
...
################################### Risk Markers Table ###################   
         ...
         if (ChipType == "CRD"){  
             ...
             if ((lang == "en") && ((disid=="MTB_01_01" && RiskMarkers != "0") || disid=="MTB_01_03" || 
                 ...
                 cat("\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="MTB_01_13" || disid=="MTB_01_04" || disid=="MTB_01_10" || 
...
if (runtype == 1)
{
    ...
    if (no_of_diseases > 10)
    {
        ...
        if (lang == "en" || lang == "in") {  
            ...
            totalwidth<-typicalsortedrowwidth*cnt + 0.2318*(cnt-1)  #for ONC
        }
