...
lblgraph_GLR<-xmlValue(top[["Graph"]][["LabelGLR"]])
lblgraph_Age<-xmlValue(top[["Graph"]][["LabelAge"]])
lblgraph_You<-xmlValue(top[["Graph"]][["LabelYou"]])
lblgraph_General_Population<-xmlValue(top[["Graph"]][["LabelGeneralPopulation"]])
lblgraph_Current_Status<-xmlValue(top[["Graph"]][["LabelCurrentStatus"]])
...
GenGRRPlot <- function(IR,Gender,GRR, AvGRR, Interval, name, DiseaseID, age ) {              #new function added for plot generation
     ...
     #cat(IR,",",Gender,",",GRR,",",AvGRR,",",Interval,",",name,",",DiseaseID,",",age,file="chkval.txt",append=TRUE,"\n")

     x<-numeric(0)
     y<-numeric(0)
     z<-numeric(0)

     if(ChipType == "CRD" || ChipType == "MTB" || ChipType == "OST"|| ChipType == "PDI" || ChipType == "PDC" || ChipType == "TCM") {
       maxrfile<-paste("Risk_Score/Dtect_",ChipType,".Max.xml",sep="")
       maxriskfile<-xmlParse(maxrfile)
       dat<-xmlRoot(maxriskfile)
       maxGRR<-as.numeric(xmlValue(dat[[DiseaseID]]))
       if(ChipType == "PDI" || ChipType == "PDC") {maxGLR<-(maxGRR*(1-exp(-IR*15/10000)))*100 } else {maxGLR<-(maxGRR*(1-exp(-IR*80/10000)))*100 }
     }
     ...
     for ( i in 0:maxlimit)
     {
          ...
          if(t== 0) {
             ...
             AvGLR<-AvGRR*CI
             if (ChipType == "CRD"|| ChipType == "MTB" || ChipType == "OST"|| ChipType == "PDI" || ChipType == "PDC" || ChipType == "TCM") {
                 if (DiseaseID=="CRD_01_02" || DiseaseID=="CRD_01_04" ||DiseaseID=="CRD_01_09" ||DiseaseID=="CRD_01_11" ||DiseaseID=="CRD_01_12" ||DiseaseID=="CRD_01_14" ||
                     DiseaseID=="MTB_01_01"||DiseaseID=="MTB_01_12"||DiseaseID=="MTB_01_04"||DiseaseID=="MTB_01_05"||DiseaseID=="MTB_01_09" ||
                     DiseaseID=="OST_01_07"||DiseaseID=="OST_01_08"||DiseaseID=="OST_01_09" ||
                     DiseaseID=="PDC_01_02"||DiseaseID=="PDC_01_04"||DiseaseID=="PDC_01_07"||DiseaseID=="PDC_01_08"||DiseaseID=="PDC_01_09" ||
                     DiseaseID=="TCM_01_01"||DiseaseID=="TCM_01_03"||DiseaseID=="TCM_01_04"||DiseaseID=="TCM_01_05"||DiseaseID=="TCM_01_07"||DiseaseID=="TCM_01_08"||
                     DiseaseID=="TCM_01_11"||DiseaseID=="TCM_01_14"||DiseaseID=="TCM_01_19"||DiseaseID=="TCM_01_20")
                 {
                    #cat(paste(name,maxGRR,maxGLR,GLR,AvGLR,sep="\t"),file=paste("Test_File1.txt"),append=TRUE,"\n")
                    GLR<-(GLR*100)/maxGLR
                    AvGLR<-(AvGLR*100)/maxGLR
                    #cat(paste(name,maxGRR,maxGLR,GLR,AvGLR,sep="\t"),file=paste("Test_File2.txt"),append=TRUE,"\n")
                 }
             }
             push(x,i)
             push(y,GLR*100)
    ...
    if (DiseaseID=="CRD_01_02" || DiseaseID=="CRD_01_04" ||DiseaseID=="CRD_01_09" ||DiseaseID=="CRD_01_11" ||DiseaseID=="CRD_01_12" ||DiseaseID=="CRD_01_14" ||
        ...
        DiseaseID=="TCM_01_11"||DiseaseID=="TCM_01_14"||DiseaseID=="TCM_01_19"||DiseaseID=="TCM_01_20")
        {
           segy<-(segy*100)/maxGLR
        }
  
    if (lang == "zh"||lang == "ch") {
            pdf(paste("./tmp/",DiseaseID,".pdf",sep=""),width=10,height=7,family="GB1")   
    }else if (lang =="ru"){
            pdf(paste("./tmp/",DiseaseID,".pdf",sep=""),width=10,height=7,family= "URWHelvetica",  encoding="KOI8-R") 
    } else {
           pdf(paste("./tmp/",DiseaseID,".pdf",sep=""),width=10,height=7)
    }
    ...
    if(ChipType == "PDC"|| ChipType == "PDI") {
      if (lang == "ru") {
          plot(x, y, type="l", lwd=3, col=col1,ylim=c(0, max(y,z)*1.2), cex.lab=2,cex.names=1.8,cex.axis=1.8, xlim=c(0,max(x)+1), xlab=lblgraph_Age,ylab="", main=paste(name),xaxs="i",yaxs="i", yaxt="n",cex.main =2.5, las =0,xpd=TRUE)
      } else {
          plot(x, y, type="l", lwd=3, col=col1,ylim=c(0, max(y,z)*1.2), cex.lab=2,cex.names=1.8,cex.axis=1.8, xlim=c(0,max(x)+1), xlab=lblgraph_Age,ylab="", main=paste(name),xaxs="i",yaxs="i", yaxt="n",cex.main =3, las =0,xpd=TRUE)
      }
      ...
      if (lang == "ru") {
          plot(x, y, type="l", lwd=3, col=col1,ylim=c(0, max(y,z)*1.2), cex.lab=2,cex.names=1.8,cex.axis=1.8, xlim=c(0,max(x)+5), xlab=lblgraph_Age,ylab="", main=paste(name),xaxs="i",yaxs="i", yaxt="n",cex.main =2.5, las =0,xpd=TRUE)
      } else {  
          plot(x, y, type="l", lwd=3, col=col1,ylim=c(0, max(y,z)*1.2), cex.lab=2,cex.names=1.8,cex.axis=1.8, xlim=c(0,max(x)+5), xlab=lblgraph_Age,ylab="", main=paste(name),xaxs="i",yaxs="i", yaxt="n",cex.main =3, las =0,xpd=TRUE)
      } 
    ...
    title(ylab = lblgraph_GLR, cex.lab = 2,line = 4,font.axis=2)
    ...
    legend("center",legend=c(lblgraph_You), lwd=c(2,2,2), col=c(col1), cex=1.8, lty = c(1), pch = c(23),merge = TRUE, bg = "white",pt.bg=c(col1),bty = "n")
    par(mar = c(0, 0, 0, 0))
    plot(1:3, rnorm(3), pch = 1, lty = 1, ylim=c(-2,2), type = "n", axes = FALSE, ann = FALSE)
    legend("center",legend=c(lblgraph_General_Population), lwd=c(2,2,2), col=c("black"), cex=1.8, lty = c(1), pch = c(23),merge = TRUE, bg = "white",pt.bg=c("black"),bty = "n")
    par(mar = c(0, 0, 0, 0))
    plot(1:3, rnorm(3), pch = 1, lty = 1, ylim=c(-2,2), type = "n", axes = FALSE, ann = FALSE)
    legend("center",legend=c(lblgraph_Current_Status), lwd=c(2), col=c("goldenrod2"), cex=1.8, lty = c(1),merge = TRUE, bg = "white",pt.bg=c("goldenrod2"),bty = "n")
    dev.off()
}
...
if (lang != "en") {
    CoverAssertion<-xmlValue(top[["GeneralInformation"]][["CoverAssertion"]])
    cat("\\small","\n")
    
    if (lang == "in") { cat("~\\\\[15pt]","\n") }
    else if (lang == "ru") { cat("~\\\\[-30pt]","\n") } 
    else if(lang =="zh" && numline > 3) {
     cat("~\\\\[15pt]","\n")
    }
    else { cat("~\\\\[25pt]","\n") }
...
if (lang=="ru"){
    TmpStr = strsplit(as.character(LetterName),"/")
    if (PatientGender == "M") { LetterName<-TmpStr[[1]][1] }
    else { LetterName<-TmpStr[[1]][2] } 
}
...
if (lang == "in") {
    if (ChipType == "CRD") { cat("~\\\\[5pt]","\n") } 
    else { cat("~\\\\[25pt]","\n") } 
} else if (lang == "ru" && ChipType == "CRD") {
    cat("~\\\\[0pt]","\n")
} else {
    cat("~\\\\[40pt]","\n") 
}
...
cat(paste("\\fancyhead[OR]{\\begin{mdframed}[linecolor=white,roundcorner=0pt,backgroundcolor=white,innerleftmargin=0,innertopmargin=0,innerbottommargin=0]\\parbox[t]{1.0\\textwidth}{\\raggedright","\\includegraphics[width=0.18\\linewidth]{",chiplogo,"}}","\\parbox[t]{0.333\\textwidth}{\\centering Page}\\parbox[t]{0.333\\textwidth}{\\raggedleft 3} \\end{mdframed}}",sep=""),"\n")
cat(paste("\\fancyhead[EL]{\\begin{mdframed}[linecolor=white,roundcorner=0pt,backgroundcolor=white,innerleftmargin=0,innertopmargin=0,innerbottommargin=0]\\parbox[t]{1.035\\textwidth}{\\raggedleft","\\includegraphics[width=0.18\\linewidth]{",chiplogo,"}}","\\parbox[t]{0.333\\textwidth}{\\centering Page}\\parbox[t]{0.333\\textwidth}{\\raggedright 3} \\end{mdframed}}",sep=""),"\n")
...
{
    if (lang == "zh" || lang == "ch") {
        cat(paste("\\includegraphics[trim=0.25cm 0.35cm 0cm 0cm, clip=true,width=",imagewidth_CRD,"\\linewidth]{",Section1,"}",sep=""),"\n") 
    } else if (lang == "in") {
        cat(paste("\\includegraphics[trim=0.25cm 0.45cm 0cm 0cm, clip=true,width=",imagewidth_CRD,"\\linewidth]{",Section1,"}",sep=""),"\n")   
    } else if(lang=="ru") {
        cat(paste("\\includegraphics[trim=0.25cm 0.6cm 0cm 0cm, clip=true,width=",imagewidth_CRD,"\\linewidth]{",Section1,"}",sep=""),"\n")
    } else {
        cat(paste("\\includegraphics[trim=0.25cm 0.3cm 0cm 0cm, clip=true,width=",imagewidth_CRD,"\\linewidth]{",Section1,"}",sep=""),"\n")
    }
} else {
    if (lang == "ch") { 
        cat(paste("\\includegraphics[trim=0cm 0.35cm 0cm 0cm, clip=true,width=",imagewidth,"\\linewidth]{",Section1,"}",sep=""),"\n")
    } else if (lang == "ru") {
        cat(paste("\\includegraphics[trim=0cm 0.005cm 0cm 0cm, clip=true,width=",imagewidth,"\\linewidth]{",Section1,"}",sep=""),"\n")    
    } else {
        cat(paste("\\includegraphics[trim=0cm 0.1cm 0cm 0cm, clip=true,width=",imagewidth,"\\linewidth]{",Section1,"}",sep=""),"\n")
    }
}

if((lang == "zh"||lang == "ch") && ChipType != "CRD"){
   cat("~\\\\[-5pt]","\n")
} else {
   cat("~\\\\[-15pt]","\n")
}
...
if (lang == "ru" && ChipType == "CRD") {
    cat("\\textcolor{logcol}{\\line(1,0){340}}","\n")
} else {
...
if (runtype == 1)
{
    diseaseindexfile<-read.csv("GSS_ReportV3_OST.disindex",sep="^",quote="\"",header=F)
    indexmap=list()
    indexmap2=list()
    for (ii in 1:nrow(diseaseindexfile))
    {
         ...
         dname<-gsub("\\'","",dname)
         cat(paste(diseaseindexfile[ii,1],diseaseindexfile[ii,2],sep=""),file="manishtest",append=TRUE,"\n")
         indexmap[[dname]]= diseaseindexfile[ii,2]
         indexmap2[[diseaseindexfile[ii,1]]]=diseaseindexfile[ii,2]       
    }
    ...
    for (rs in 1:rsize) {
         ...
         if (tag == "Disease")
         {
             IR<-xmlValue(top[["Summary"]][["Results"]][rs][["Result"]][["Incidence"]])

             if (length(grep("\\(",IR))==1)
             {
                 IRStr<-strsplit(as.character(IR)," ")
                 IR<-as.numeric(IRStr[[1]][1])
             }
             else {
                 IR<-as.numeric(IR)
             }
             ...
             if (SubType_Trait == 'N') {
                 if (as.numeric(data[4,rs]) > 1){  

                     if (lang=="zh"||lang == "ch"||lang == "in") {
                         if (ChipType == "CRD") {  
                             if (DiseaseID == "CRD_01_11"){
                                 disname<-sub("\\(COPD\\)", "",disname) 
                             } else if (DiseaseID == "CRD_01_09"){
                                 disname<-sub("\\(DVT\\)", "",disname)
                                 disname<-sub("\\(PE\\)", "",disname) 
                             }  
                         } else if (ChipType == "ONC") {
                             if (DiseaseID=="ONC_01_08"){
                                 disname<-sub("\\(ESCC\\)", "",disname) 
                             }
                         }
                     } else if (lang == "en" && ChipType == "PDC") {
                         if (DiseaseID == "PDC_01_03"){
                             disname<-sub("\\(ADHD\\)", "",disname) 
                         }
                     } else if (lang == "en" && ChipType == "TCM") {
                         if (DiseaseID == "TCM_01_05"){
                             disname<-sub("\\(COPD\\)", "",disname) 
                         } else if (DiseaseID == "TCM_01_08"){
                             disname<-sub("\\(DVT\\)", "",disname)
                             disname<-sub("\\(PE\\)", "",disname) 
                         }
                     }
                     ...
                     push(column2,data[2,rs])
                     push(column3,data[3,rs])
                     push(column4,data[4,rs])
                 ...
                 if (as.numeric(markers) > 0) {            
                     if (lang == "ru" && ChipType == "MTB") {
                         if (DiseaseID == "MTB_01_06") {
                             disname<-"Гипер-триглицеридемия"   
                         }                               
                     } else if (lang == "ru" && ChipType == "CRD") {
                         if (DiseaseID == "CRD_01_10") {
                             disname<-"Гипер-триглицеридемия"
                         }
                     }
    ...
    if (lang=="ru") {
        rowwidth1<-round(5/nrow(data1),5)
    } else { 
    ...
    if ((lang == "in") && (nrow(data2) < 2))  
    {
        rowwidth2<-round(4.5/nrow(data2),3)
    }else if(lang=="ru") {
        rowwidth2<-round(4.8/nrow(data2),3)
    } else {
    ...
    if ((nrow(data1) + nrow(data2)) == 11) { 
        rowwidth1<-1.15
        rowwidth2<-0.9   
    }

    if (lang=="ru") {
        rowwidth3<-round(4.2/nrow(data3),3)
    } else {
    ...
    if (nrow(data3) == 13) { 
        rowwidth3<-0.84 
    } else if ((lang == "en") && (nrow(data1) == 1) && (nrow(data3) == 9)) { 
        rowwidth3<-0.72 
    } else if ((lang == "en") && (nrow(data1) == 2) && (nrow(data3) == 7)) {
        rowwidth3<-0.70
    } else if ((ChipType=="COR") && (lang == "en") && (nrow(data2) == 7) && (nrow(data3) == 3)) {
        rowwidth2<-0.85
        rowwidth3<-1.15
    }
    ...
    if ((nrow(sorteddata) + nrow(sorteddata_trait))!= 0 )
    {
        ...
        if (lang == "zh" || lang == "ch") {
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.2cm}|M{1.5cm}|M{.67cm}|}","\n")
        } else if (lang == "in"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.1cm}|M{1.37cm}|}","\n")
        } else if (lang == "ru"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.6cm}|M{.87cm}|}","\n")
        } else {
        ...
        if (lang == "in" || lang == "ru") { colwidth1<-"2.9" }   
        else { colwidth1<-"3.4" } 
...
if ((nrow(data1)) < 10)
{
        if (nrow(data1) != 0 ){
            for (rs in 1:nrow(data1)) {      
                 ...
                 cat(paste("\\parbox[t][",rowwidth1,"cm]{",colwidth1,"cm}{\\raggedright ",data1[rs,1],"} & ", data1[rs,4] ,"&",data1[rs,5]   ,"\\\\",sep=""),"\n") 
                 cat("\\hline","\n")             
            }    
            mtrait<-mtrait+3     
        }
        ...
        if (nrow(data2) != 0 ){
            for (rs in 1:nrow(data2)) {                        
                 ...
                 cat(paste("\\parbox[t][",rowwidth2,"cm]{",colwidth1,"cm}{\\raggedright ",data2[rs,1],"} & ", data2[rs,4] ,"&",data2[rs,5]   ,"\\\\",sep=""),"\n")
                 cat("\\hline","\n")             
            }  
            mtrait<-mtrait+3       
        }
        ...
        if ((nrow(data1) == 0 || nrow(data2) == 0) && nrow(sorteddata) < 11){
            increasedflag<-1 

            if (nrow(data3) != 0 ) {        
                for (rs in 1:nrow(data3)) {                        
                     cat("\\rowcolor[RGB]{255,255,51} ")                
                     cat(paste("\\parbox[t][",rowwidth3,"cm]{",colwidth1,"cm}{\\raggedright ",data3[rs,1],"} & ", data3[rs,4] ,"&",data3[rs,5]   ,"\\\\",sep=""),"\n")
                     cat("\\hline","\n")    
                }      
                mtrait<-mtrait+4  
            }
                ...
                for (rs in 1:tmax)
                {
                     if (sorteddata_trait[rs,3] != "0" )
                     {
                         if((nrow(data3)+count) < 9) {                       
                            ...
                            if (lang == "in" && ChipType == "PDC" && (sorteddata_trait[rs,6] == "PDC_01_10")) { this_rowwidth<-1.088 }
                            else if(lang=="ru") {this_rowwidth<-1.028}
                            else { this_rowwidth<-1.008 }                            

                            #cat(paste("\\parbox[t][",this_rowwidth,"cm]{",colwidth1,"cm}{\\raggedright ",sorteddata_trait[rs,1],"} & ", "N/A" ,"&",sorteddata_trait[rs,5]   ,"\\\\",sep=""),"\n")
                            #cat("\\hline","\n")
                            ptrait<-ptrait+1
                         }
                         count<-count+1
        ...
        if (lang == "en" || lang == "in") {
            ...
            cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblIncreasedRisk_col3_title,"}} \\\\[1.54cm]",sep=""),"\n")
        } else { 
            cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblIncreasedRisk_col3_title,"}} \\\\[0.39cm]",sep=""),"\n")         
        }
        cat("\\endfirsthead","\n")
        ...
        if (lang == "en" || lang == "in" || lang == "ru") {  
            totalwidth<-rowwidth1*nrow(data1) + 0.2744*(nrow(data1)-1)
        } else {
            totalwidth<-rowwidth1*nrow(data1) + 0.2318*(nrow(data1)-1)
        }
        ...
        if (lang == "en" || lang == "in" || lang == "ru") {
            ...
            totalwidth<-rowwidth2*nrow(data2) + 0.2318*(nrow(data2)-1)
        }
        ...
        #/////////////// Cater for ONC_Dummy data (where category 1 has 10 diseases) used for testing purposes //////////////////////////
        ...
        if ((nrow(data1) == 0 || nrow(data2) == 0) && nrow(sorteddata) < 11) {
             if (lang == "en" || lang == "in") {
                 ...
                 totalwidth<-rowwidth3*nrow(data3) + 0.2844*(nrow(data3)-1)
             } else {
                 totalwidth<-rowwidth3*nrow(data3) + 0.2318*(nrow(data3)-1)
             }
                 ...
                 for (rs in 1:tmax) {
                      if (sorteddata_trait[rs,3] != "0" )
                      {
                          if ((nrow(data3)+count) < 9) {
                              ...
                              if (lang == "in" && ChipType == "PDC" && (sorteddata_trait[rs,6] == "PDC_01_10")) { this_rowwidth<-1.088 }
                              else if(lang=="ru") {this_rowwidth<-1.042}
                              else if(lang=="en" && ChipType == "OST") {this_rowwidth<-1.015}                                 
                              else { this_rowwidth<-1.008 } 
                              
                              #cat(paste("\\parbox[t][",this_rowwidth,"cm]{4.5cm}{\\textcolor{black}{","\\cellcolor{rowcol}", count_risk_markers,"}}\\\\",sep=""),"\n")
                              #cat("\\hline","\n")
                         }
                         count<-count+1
                     }   
        ...
        {    
            ...
            if (lang == "en" || lang == "in") { 
                ...
                if (lang == "en") {    
                    ...
                    totalwidth<-rowwidth3*nrow(data3) + 0.28*(nrow(data3)-1)
                }               
            } else if(lang == "ru") {
                cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblIncreasedRisk_col3_title,"}} \\\\[1.54cm]",sep=""),"\n")
                cat("\\endfirsthead","\n")
   ...
   ###############################################################################################################################################################
        ...
        if (lang == "zh" || lang == "ch") {
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.2cm}|M{1.5cm}|M{.67cm}|p{4.5cm}|}","\n")
        } else if (lang == "in"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.1cm}|M{1.37cm}|p{4.5cm}|","\n")
        } else {
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.4cm}|M{1.1cm}|M{.87cm}|p{4.5cm}|}","\n")
        }
        ...
        cat("\\endhead","\n")
        cat("\\hline","\n")
        cat(paste("\\multicolumn{4}{|c|}{",No_HighRisk_Disease,"}\\\\",sep=""),"\n")        
        cat("\\hline","\n")
        cat("\\end{longtable}}","\n")    
   }
}
...
if (xmlSize(diseases) !=0)
{
   ...
   {       
         ...
         if(traitflag=="Y")
         {
             ...
             cat("~\\\\","\n")
             #cat(paste("\\textbf{\\textcolor{black}{",name,"}",sep=""),"\n")
             
             cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.8cm}|M{4.6cm}|M{.7cm}|M{2.5cm}|}","\n")
             cat("\\hline","\n")
             cat("\\rowcolor{textcol}","\n")
             Title1<-DrugHeader1<-xmlValue(top[["Summary"]][["TraitTable"]][["Col1"]])
             Title2<-DrugHeader1<-xmlValue(top[["Summary"]][["TraitTable"]][["Col2"]])
             Title3<-DrugHeader1<-xmlValue(top[["Summary"]][["TraitTable"]][["Col3"]])
             Title4<-DrugHeader1<-xmlValue(top[["Summary"]][["TraitTable"]][["Col4"]])
             cat(paste("\\textbf{\\textcolor{white}{",Title1,"}} &","\\textbf{\\textcolor{white}{",Title2,"}} &","\\textbf{\\textcolor{white}{",Title3,"}} &","\\textbf{\\textcolor{white}{",Title4,"}}", "\\\\",sep=""),"\n")
             cat("\\hline","\n")
             ...
             rowtable<-catalog["GenoEffect"]
                 ...
                 {      
                   ...
                   RelativeRisk<-as.numeric(xmlValue(rowtable[c][["GenoEffect"]][["Genotypes"]][["Genotype"]][["RelativeRisk"]]))
                   rsid<-xmlValue(rowtable[c][["GenoEffect"]][["Genotypes"]][["Genotype"]][["SNP"]]) 
                   gene<-xmlValue(rowtable[c][["GenoEffect"]][["Genotypes"]][["Genotype"]][["Gene"]])
                   TraitRecommendations<-xmlValue(rowtable[c][["GenoEffect"]][["Genotypes"]][["Genotype"]][["TraitInfo"]][["TraitRecommendations"]])
                   TraitSummary<-""
                   TraitSummary<-xmlValue(rowtable[c][["GenoEffect"]][["Genotypes"]][["Genotype"]][["TraitInfo"]][["TraitSummary"]])
                   page_num<-""
                   mapkey<-paste(rsid,"-",disid,sep="")
                   if (runtype == 1){
                       
                       page_num<-indexmap[[mapkey]]
                   }
                   cat("\\rowcolor{rowcol}","\n")
                   cat(paste(rsid,"/",gene,"& ","\\parbox[t]{4.5cm}{",TraitSummary,"}& ",page_num, "&",TraitRecommendations, "\\\\",sep=""),"\n")
                   cat("\\hline","\n")
                 }
                 cat("\\end{longtable}}","\n")
          }                       
    ...
    cat(Caption,"\n")  
    cat("\\newpage","\n")
    TraitResultInterpretationTitle<-xmlValue(top[["TraitResultInterpretation"]][["Title"]])
    
    cat("\\textbf{\\center",TraitResultInterpretationTitle,"}\n")
   
    TraitResultInterpretationContent<-xmlValue(top[["TraitResultInterpretation"]][["Content"]])
    TraitResultInterpretationCaption1<-xmlValue(top[["TraitResultInterpretation"]][["Caption1"]])
    TraitResultInterpretationCaption2<-xmlValue(top[["TraitResultInterpretation"]][["Caption2"]])

    cat(TraitResultInterpretationContent,"\n")
    cat("~\\\\","\n")
    cat("~\\\\","\n")
    cat(paste("\\includegraphics[width=1.0\\linewidth]{image/Table1}",sep=""),"\n")
    cat("~\\\\","\n")
    cat(TraitResultInterpretationCaption1,"\n")
     
    cat("~\\\\","\n")
    cat(paste("\\includegraphics[width=1.0\\linewidth]{image/Table2}",sep=""),"\n")
    cat(TraitResultInterpretationCaption2,"\n")
}
...
if (ChipType=="CRD" && runtype == 1)
{
    ...
    {
        cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|P{3.3cm}|M{1.5cm}|M{3.9cm}|M{1.3cm}|}","\n")
    }
    else
    {
...
if ((ChipType == "MTB" && (lang == "en" || lang == "in" || lang == "ru"))||(ChipType == "CRD" && (lang == "in" || lang == "ru"))) {
    cat("\\begin{center}","\n")
...
#ChipTypeName<-sub("Report","",ChipTypeName)
...
#} else {
#    Title<-sub("\\$\\{cover_title\\}",ChipTypeName,Title_Tmp)
#}
...
#if (lang == "en") {
#    Content1<-sub("\\$\\{cover_title\\}",CoverTitle,Content1)
#} else {
...
#Content2_Tmp<-gsub("\\$\\{cover_title\\}",ChipTypeName,Content2_Tmp)
...
#if (lang == "in") {
#    Formula3<-sub("yang",";yang",Formula3)
#    array_Formula3<-strsplit(Formula3,";")
#    cat(paste(Formula2," \\frac{ \\textit{\\textrm{",Formula1,"}}}{ \\textit{\\textrm{",array_Formula3[[1]][1],"}}}\\\\",sep=""),"\n")
#
#} else {
...
#if (lang == "in") {
#    cat("\\hspace{5.2cm}","\n")
#    cat("\\textit{\\textrm{",array_Formula3[[1]][2],"}}","\n")
#}
...
if (lang == "zh") {
   cat(paste("\\includegraphics[trim=0.23cm 0.1cm 0cm 0cm, clip=true,width=0.63\\linewidth]{",Section2,"}",sep=""),"\n")
   cat("~\\\\[-2pt]","\n")
} else if (lang == "ch") {
   cat(paste("\\includegraphics[trim=0.23cm 0.25cm 0cm 0cm, clip=true,width=0.49\\linewidth]{",Section2,"}",sep=""),"\n")
   cat("~\\\\[-2pt]","\n")
} else if (lang == "ru") {
   cat(paste("\\includegraphics[trim=0.23cm 0.5cm 0cm 0cm, clip=true,width=1.05\\linewidth]{",Section2,"}",sep=""),"\n")
   cat("~\\\\[-15pt]","\n")
} else {
...
if (xmlSize(diseases) !=0)
{
    ...
    if(ChipType == "CRD" || ChipType == "MTB"|| ChipType == "PDC" || ChipType == "PDI" || ChipType == "OST" || ChipType == "TCM")
    {
       maxrfile<-paste("Risk_Score/Dtect_",ChipType,".Max.xml",sep="")
       maxriskfile<-xmlParse(maxrfile)   
    }
    ...
    {       
         ...
         if(lang=="ru") {
            cat(paste("\\write\\indexfile{\\unexpanded{",name,"}^" ,"\\thepage}",sep=""),"\n") 
         } else {
            cat(paste("\\write\\indexfile{",name,"^" ,"\\thepage}",sep=""),"\n") 
         }

         cat(paste("\\fancyhead[OR]{\\begin{mdframed}[linecolor=textcol,roundcorner=0pt,backgroundcolor=textcol,innerleftmargin=0,innertopmargin=4,innerbottommargin=4]\\parbox[t]{1.0\\textwidth}{\\raggedright","\\textbf{ \\textcolor{white}{\\normalsize ",name,"}}","}\\parbox[t]{0.333\\textwidth}{\\centering Page}\\parbox[t]{0.333\\textwidth}{\\raggedleft 3} \\end{mdframed}}",sep=""),"\n")
         cat(paste("\\fancyhead[EL]{\\begin{mdframed}[linecolor=textcol,roundcorner=0pt,backgroundcolor=textcol,innerleftmargin=0,innertopmargin=4,innerbottommargin=4]\\parbox[t]{1.0\\textwidth}{\\raggedleft","\\textbf{ \\textcolor{white}{\\normalsize ",name,"}}","}\\parbox[t]{0.333\\textwidth}{\\centering Page}\\parbox[t]{0.333\\textwidth}{\\raggedright 3} \\end{mdframed}}",sep=""),"\n")
         ...
         cat(paste("\\begin{minipage}{",minipage_len,"\\linewidth}","\n"))
         cat("\\hspace{0cm}","\n")
         cat("\\end{minipage}","\n")
         ...
         cat(paste("\\fbox{\\begin{minipage}{",minipage_len,"\\linewidth}","\n"))
         ...
         if (traitflag == 'N') {  
             ...
             disname<-name
             IR<-xmlValue(top[["Summary"]][["Results"]][i][["Result"]][["Incidence"]])
             ...
             if (ChipType == "CRD" || ChipType == "MTB" || ChipType == "OST"|| ChipType == "PDI" || ChipType == "PDC" || ChipType == "TCM") {                                                     
                dat<-xmlRoot(maxriskfile)
                maxGRR<-round(as.numeric(xmlValue(dat[[disid]])),2)
                maxGLR<-round((maxGRR*(1-exp(-IR*maxage/10000)))*100,3) 
             } 
             ...
             if (ChipType == "CRD"|| ChipType == "MTB" || ChipType == "OST"|| ChipType == "PDI" || ChipType == "PDC" || ChipType == "TCM") {
                 if (disid=="CRD_01_02" || disid=="CRD_01_04" ||disid=="CRD_01_09" ||disid=="CRD_01_11" ||disid=="CRD_01_12" ||disid=="CRD_01_14" ||
                     disid=="MTB_01_01"||disid=="MTB_01_12"||disid=="MTB_01_04"||disid=="MTB_01_05"||disid=="MTB_01_09" || 
                     disid=="OST_01_07" ||disid=="OST_01_08" ||disid=="OST_01_09" ||
                     disid=="PDC_01_02"||disid=="PDC_01_04"||disid=="PDC_01_07"||disid=="PDC_01_08"||disid=="PDC_01_09" ||
                     disid== "TCM_01_01" || disid=="TCM_01_03" || disid == "TCM_01_04" || disid == "TCM_01_05" || disid == "TCM_01_07" || disid=="TCM_01_08" || 
                     disid== "TCM_01_11" || disid== "TCM_01_14" || disid == "TCM_01_19" || disid == "TCM_01_20")
                 {
                     GLR<-round((GLR*100/maxGLR),2)
                     AvGLR<-round((AvGLR*100/maxGLR),2)
             ...
             Note<-sub("<=","\\$\\\\leq\\$",Note)
             GRR_Note<-xmlValue(top[["GeneticTable"]][["Note"]])  
             GRR_Note<-sub("\\$\\{GRR_Value\\}",GRR,GRR_Note)          
            
             if (lang == "in") {
                 cat("\\begin{minipage}{0.3\\linewidth}","\n")     #newchange
                 cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{1.35cm}|M{1.5cm}|}","\n")
             } else { 
             ...
             if (lang == "in") {
                 cat(paste("\\rowcolor{textcol} \\multicolumn{2}{|p{3.3cm}|}{\\textbf{\\textcolor{white}{",TblGenetic_col2_title,"}}}\\\\",sep=""),"\n") 
             } else if(lang == "ru") {
                 cat(paste("\\rowcolor{textcol} \\multicolumn{2}{|p{4.3cm}|}{\\textbf{\\textcolor{white}{",TblGenetic_col2_title,"}}}\\\\",sep=""),"\n")
             } else {
             ...
             if (lang =="in") {
                 cat(paste("\\parbox[t][1.75cm]{1.35cm}{\\textbf{",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", GLR,"\\%}}\\\\",sep=""),"\n")
                 cat("\\hline","\n")
                 cat("\\rowcolor{rowcol}","\n") 
                 cat(paste("\\parbox[t][1.75cm]{1.35cm}{\\textbf{",TblGenetic_row2_title,"}}  & \\textbf{\\textcolor{black}{",AvGLR,"\\%}}\\\\",sep=""),"\n")
             } else {
             ...
             if (lang == "in") {
                 width<-7.6
                 cat("\\begin{minipage}{0.57\\linewidth}","\n")
             } else {
                 width<-6.6
                 cat("\\begin{minipage}{0.67\\linewidth}","\n")
             } 

             cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{",width,"cm}|}","\n")

             cat("\\hline","\n")
             cat("\\rowcolor{textcol}","\n") 

             if (lang == "in") {
                 cat(paste("\\textbf{\\textcolor{white}{",TblGenetic_col3_title,"}}\\\\[.3251cm]",sep=""),"\n")
             } else { 
             ...
             if (lang == "ch" || lang == "zh"){
                 totalwidth<-3.8+0.1888
             } else if (lang == "in") {  
                 totalwidth<-3.54+0.1848 
             } else {
                 totalwidth<-3.8+0.2294
             }

             if (GRR >= 2) {
                 cat(paste("\\parbox[t][",totalwidth,"cm]{",width,"cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\", Note1,"}}\\\\",sep=""),"\n")
             } else if (GRR > 1.0 && GRR <= 1.49) {
                 cat(paste("\\parbox[t][",totalwidth,"cm]{",width,"cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\",Note3,"}}\\\\",sep=""),"\n")
             }
             else if (GRR < 1.0) {              
                 cat(paste("\\parbox[t][",totalwidth,"cm]{",width,"cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\",Note,"}}\\\\",sep=""),"\n")
             } 
             else {
                 cat(paste("\\parbox[t][",totalwidth,"cm]{",width,"cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\",Note2,"}}\\\\",sep=""),"\n")
             }
             ...
             if (file.exists(ImageFile)) {
                 if (lang == "ru") { 
                     cat("\\begin{mdframed}[linecolor=black,roundcorner=0pt,innerleftmargin=0,innertopmargin=0,innerbottommargin=0,innerrightmargin=0,everyline = true, outerlinewidth=0.1, splittopskip=1cm, splitbottomskip=.5cm]","\n") 
                 } else {
                 ...
                 if (lang == "in") {
                     cat(paste("\\includegraphics[trim=0.21cm 2.5cm 0cm 0.3cm, clip=true,width=0.90\\linewidth]{",ImageFile,"}",sep=""),"\n")
                 } else if(lang=="ru") {
                     cat(paste("\\includegraphics[trim=0.15cm 2.5cm 0cm 0.6cm, clip=true,width=0.95\\linewidth,height=0.45\\linewidth]{",ImageFile,"}",sep=""),"\n")
                 } else {
...
#         if (disid == "CRD_01_01" || disid == "CRD_01_02" || disid == "CRD_01_03" || disid == "CRD_01_04"||
#             disid == "CRD_01_05" || disid == "CRD_01_06" || disid == "CRD_01_07" || disid == "CRD_01_08"||
#             disid == "CRD_01_09" || disid == "CRD_01_10" || disid == "CRD_01_11" || disid == "CRD_01_12"||
#             disid == "CRD_01_13" || disid == "CRD_01_14" || disid == "CRD_01_15" || disid == "CRD_01_16"||
#             disid == "CRD_01_17" || disid == "CRD_01_18" || disid == "CRD_01_19" || disid == "CRD_01_20"
#) {
#             Text<- ""
#         } 
           ...
           if(traitflag== "Y" && disid != "OST_01_06") 
           {
               ...
               for (k in 1:xmlSize(genoeffects))
               {
                   ...
                   { 
                      ...
                      cat("~\\\\[15pt]","\n")
                      cat(paste("\\write\\indexfile{",snp,"-",disid,"^" ,"\\thepage}",sep=""),"\n")
                      cat(paste("\\textbf{\\noindent{",snp,"}}",sep=""),"\n")
         ...
         if (ChipType == "ONC" && ((disid == "ONC_01_30" && PatientGender == "F") || 
             (disid == "ONC_01_33" && PatientGender == "F") || (disid == "ONC_01_03" && PatientGender == "M") ||
             (disid == "ONC_01_04" && PatientGender == "M") || (disid == "ONC_01_06" && PatientGender == "M") ||
             (disid == "ONC_01_28" && PatientGender == "M"))) 
         { 
             Text<-""
             ...
             if (!(lang == "ru" && (disid == "ONC_01_04" || disid == "ONC_01_28"))) { cat("~\\\\","\n") }                
         ...
         if (Text != ""){   
             ...
             if (ChipType == "CRD") {
                 cat("~\\\\","\n")  
                 if ((lang == "en") && (disid == "CRD_01_09")) { cat("~\\\\[-0pt]","\n") }
                 else if ((lang == "en" || lang == "in" || lang == "ru") && (disid == "CRD_01_13")) { cat("~\\\\[-10pt]","\n") }  
                 else if ((lang == "in") && (disid == "CRD_01_01"||disid == "CRD_01_04")) { cat("~\\\\[-0pt]","\n") }
                 else { cat("~\\\\","\n") }  
                 ...
                 if ((lang == "in") && (disid == "ONC_01_24")) {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 } else if ((lang == "in" || lang == "ru") && disid == "ONC_01_30") {
                     cat("\\newpage","\n")                       
                 } else if (lang == "ch" || lang == "zh") {
                     #if (disid == "ONC_01_01" || disid == "ONC_01_02" || disid == "ONC_01_03" || disid == "ONC_01_04" ||
                     #    disid == "ONC_01_05" || disid == "ONC_01_06" || disid == "ONC_01_07" || disid == "ONC_01_08" ||
                     #    disid == "ONC_01_09" || disid == "ONC_01_10" || disid == "ONC_01_11" || disid == "ONC_01_12" || 
                     #    disid == "ONC_01_13" || disid == "ONC_01_14" || disid == "ONC_01_15" || disid == "ONC_01_18" ||
                     #    disid == "ONC_01_19" || disid == "ONC_01_20" || disid == "ONC_01_21" || disid == "ONC_01_22" ||
                     #    disid == "ONC_01_23" || disid == "ONC_01_24" || disid == "ONC_01_25" || disid == "ONC_01_27" ||
                     #    disid == "ONC_01_28" || disid == "ONC_01_29" || disid == "ONC_01_30" || disid == "ONC_01_31" ||
                     #    disid == "ONC_01_32" || disid == "ONC_01_33" || disid == "ONC_01_34"
                     #)
                     #{ 
	                    cat("~\\\\","\n")
                     #}
                     cat("~\\\\","\n")
                      ...
                      if (disid != "ONC_01_14" && disid != "ONC_01_02" && disid != "ONC_01_03" && disid != "ONC_01_33" &&
                          disid != "ONC_01_15" && disid != "ONC_01_08" && disid != "ONC_01_20" && disid != "ONC_01_09" &&
                          disid != "ONC_01_11" && disid != "ONC_01_21" && disid != "ONC_01_13" && disid != "ONC_01_24" && 
                          disid != "ONC_01_26" && disid != "ONC_01_22" && disid != "ONC_01_28" && disid != "ONC_01_32")
                      {   
                          cat("~\\\\","\n") 
                      }
                 ...
                 if ((lang == "en" || lang == "in" || lang == "ru") && (disid == "MTB_01_13" || disid == "MTB_01_03" || 
                     disid == "MTB_01_05" || disid == "MTB_01_10" || disid == "MTB_01_12" || 
                     disid == "MTB_01_11"|| disid == "MTB_01_09")) {
                     cat("~\\\\","\n")
                 } else if ((lang == "en" || lang == "in" || lang == "ru") && (disid == "MTB_01_04" || disid == "MTB_01_07")) {
                     cat("\\newpage","\n")
                 } else {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n") 
                 }
             } else if (ChipType == "TCM") {
                 if ((lang == "en") && (disid == "TCM_01_14")) {
                     cat("\\newpage","\n")
                 } else if (disid == "TCM_01_08") { 
                     cat("~\\\\[-0pt]","\n")
                     cat("~\\\\","\n")                    
                 } else {
                     cat("~\\\\","\n")
             ...
             if (ChipType == "TCM") {
                 if ((lang == "en") && (disid == "TCM_01_07" || disid == "TCM_01_08" || disid == "TCM_01_09" || 
                     disid == "TCM_01_20")) {
                     cat("~\\\\[-33pt]","\n")
                 }
             }
             ...
             if (length(booltab) == 0)
             {
                 ...
                 } else if (disid == "PDC_01_06"){
                     Text<-gsub(">=","\\$\\\\boldsymbol\\{\\\\geq\\}\\$",Text)
                 } 
             ...
             if (ChipType == "CRD") { 
                 if (lang == "en" && disid=="CRD_01_05") {
                     cat("\\newpage","\n")
                 } else if ((lang == "in") && (disid=="CRD_01_05")){ 
                      cat("\\newpage","\n")
                 } else if ((lang == "ru") && (disid=="CRD_01_01")){ 
                      cat("\\newpage","\n")  
                 }else {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 ...
                 if ((lang == "en") && ((disid=="ONC_01_03") || (disid=="ONC_01_04" && PatientGender == "F") || disid=="ONC_01_02" ||
                     disid=="ONC_01_15" || disid=="ONC_01_26"||disid=="ONC_01_22" || (disid=="ONC_01_28" && PatientGender =="M") ||
                     disid=="ONC_01_20" || disid=="ONC_01_09" || disid=="ONC_01_10" || disid=="ONC_01_12" || disid=="ONC_01_13" || 
                     disid=="ONC_01_11" || disid=="ONC_01_25" || disid=="ONC_01_34" || (disid=="ONC_01_06" && PatientGender == "F") ||
                     disid=="ONC_01_19")) {
                     cat("\\newpage","\n")      
                 } else if ((lang=="zh"||lang == "ch") && (disid=="ONC_01_18"|| (disid=="ONC_01_30" && PatientGender =="F"))) {
                     cat("\\newpage","\n")                  
                 } else if ((lang == "in") && (disid=="ONC_01_02" || disid=="ONC_01_03" || (disid=="ONC_01_04" && PatientGender == "F") ||
                             disid=="ONC_01_20" || disid=="ONC_01_19" || disid=="ONC_01_15" || disid=="ONC_01_26" || 
                             disid=="ONC_01_09" || disid=="ONC_01_34" || disid=="ONC_01_14" || (disid=="ONC_01_33" && PatientGender == "M") ||
                             disid=="ONC_01_21" || disid=="ONC_01_12" || disid=="ONC_01_18" || disid=="ONC_01_24" || disid=="ONC_01_22")){
                     cat("\\newpage","\n")
                 } else if ((lang=="ru") && (disid=="ONC_01_15" || disid=="ONC_01_21" || disid=="ONC_01_18" || disid=="ONC_01_24" ||
                            disid=="ONC_01_12" || disid=="ONC_01_26" || (disid=="ONC_01_33" && PatientGender == "M") ||
                            (disid=="ONC_01_03" && PatientGender == "F") || (disid=="ONC_01_04" && PatientGender == "F"))) {
                     cat("\\newpage","\n")
                 } else if ((lang=="ru") && (disid=="ONC_01_07")) {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 } else {
                 ...
                 if (lang == "en" && (disid=="MTB_01_10" || disid=="MTB_01_09")){ 
                      cat("\\newpage","\n")  
                 } else if (lang == "en" && disid=="MTB_01_12"){ 
                      cat("\\newpage","\n")
                 } else if (lang == "in" && disid=="MTB_01_02"){ 
                      cat("\\newpage","\n")
                 } else if (lang == "ru" && (disid=="MTB_01_02" || disid=="MTB_01_05")){ 
                      cat("\\newpage","\n")
                 } else {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 ...
                 if ((lang == "en") && (disid=="PDC_01_03" || disid=="PDC_01_06")) {
                     cat("\\newpage","\n")
                 } else if ((lang == "in") && ( disid=="PDC_01_03" || disid=="PDC_01_04")){ 
                      cat("\\newpage","\n")
                 } else if ((lang == "ru") && ( disid=="PDC_01_03" || disid=="PDC_01_04" || disid=="PDC_01_07" || disid=="PDC_01_06")) {
                      cat("\\newpage","\n")                     
                 } else {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 ...
                 if ((lang == "en") && (disid=="TCM_01_04" || disid=="TCM_01_06" || (disid=="TCM_01_15" && PatientGender == "M"))){
                     cat("\\newpage","\n")    
                 } else {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 ...
                 if ((lang == "en") && ((disid=="COR_01_06" && PatientGender == "M") || (disid=="COR_01_20" && PatientGender == "M"))){
                     cat("\\newpage","\n")   
                 } else if ((lang == "en") && ((disid=="COR_01_07" && PatientGender == "M") || disid=="COR_01_09")){ 
                     cat("~\\\\[-15pt]","\n")
                 } else {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
         ...
         if (ChipType == "CRD"){  
             if ((lang == "en") && (disid=="CRD_01_01" || disid=="CRD_01_04")) {
                  cat("\\newpage","\n")
             } else if ((lang == "in") && (disid=="CRD_01_03")) {
                  cat("\\newpage","\n")
             } else if ((lang == "ru") && (disid=="CRD_01_03" || disid=="CRD_01_09")) {
                  cat("\\newpage","\n") 
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
         } else if (ChipType == "PDI"){
             if (lang == "en" && disid=="PDI_01_10") {
                 cat("\\newpage","\n")
             } else if ((lang == "en") && (disid=="PDI_01_02" || disid=="PDI_01_04")){
                 cat("~\\\\[-15pt]","\n")  
             } else if ((lang == "zh"||lang == "ch") && (disid=="PDI_01_02" || disid=="PDI_01_04")){
                 cat("~\\\\[-15pt]","\n") 
             } else if ((lang == "in") && (disid=="PDI_01_02")){
                 cat("~\\\\[-15pt]","\n")
             } else {
                 cat("~\\\\[-4pt]","\n")  
             }    
         } else if (ChipType == "PDC"){   
             if ((lang == "en") && (disid=="PDC_01_03" || disid=="PDC_01_04" || disid=="PDC_01_10"|| disid=="PDC_01_08"|| disid=="PDC_01_06")) {
                 cat("~\\\\[-4pt]","\n")
             } else if ((lang == "en") && (disid=="PDC_01_07")) {
                 cat("\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="PDC_01_03" || disid=="PDC_01_04" || 
                        disid=="PDC_01_07" || disid=="PDC_01_08" || disid=="PDC_01_10")) {
                 cat("~\\\\[-4pt]","\n")
             } else if ((lang == "in") && (disid=="PDC_01_03" || disid=="PDC_01_04" || disid=="PDC_01_10" ||
                       disid=="PDC_01_07" || disid=="PDC_01_08")) {
                 cat("~\\\\[-4pt]","\n")
             } else if ((lang == "ru") && (disid=="PDC_01_10")) {
                 cat("\\newpage","\n")
             } else if ((lang == "ru") && (disid=="PDC_01_03" || disid=="PDC_01_04" || disid=="PDC_01_07" || disid=="PDC_01_08")) {
                 cat("~\\\\[-4pt]","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
         } else if (ChipType == "MTB"){
             if (lang == "en" && disid=="MTB_01_08") {
                 cat("\\newpage","\n")               
             } else if ((lang == "en" || lang == "in" || lang == "ru") && (disid=="MTB_01_02" || disid=="MTB_01_12" || disid=="MTB_01_11")) {
                 cat("~\\\\[-4pt]","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="MTB_01_11" || disid=="MTB_01_09")){
                 cat("\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="MTB_01_13" || disid=="MTB_01_03" || disid=="MTB_01_12" ||
                        disid=="MTB_01_08")){
                 cat("~\\\\[-4pt]","\n") 
             } else if ((lang == "in") && (disid=="MTB_01_13" || disid=="MTB_01_06")) {
                 cat("\\newpage","\n")
             } else if ((lang == "ru") && (disid=="MTB_01_08")) {
                 cat("~\\\\[-25pt]","\n")
             } else if ((lang == "ru") && (disid=="MTB_01_09")) {
                 #cat("\\newpage","\n")
                 cat("~\\\\[-50pt]","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             ...
             if ((lang == "en") & (disid=="ONC_01_07" || disid=="ONC_01_31")) 
             {
                 cat("\\newpage","\n")
                 cat("~\\\\[-27pt]","\n")
             } else if ((lang == "en" || lang == "in" || lang == "ru") && (disid == "ONC_01_26")) {
                 cat("~\\\\[-3pt]","\n") 
             } else if ((lang == "zh"||lang == "ch") && ((disid=="ONC_01_03"  && PatientGender=="F")|| disid=="ONC_01_05" || disid=="ONC_01_22" ||  
                        (disid=="ONC_01_04" && PatientGender=="F") ||(disid=="ONC_01_06" && PatientGender=="F") || 
                        (disid=="ONC_01_30" && PatientGender=="M") || disid == "ONC_01_24" || disid == "ONC_01_20" || disid == "ONC_01_23")){ 
                 cat("\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid == "ONC_01_26" || disid == "ONC_01_33" || disid=="ONC_01_09")){
                 cat("~\\\\[-3pt]","\n") 
             } else if ((lang == "ch") && (disid == "ONC_01_32")) {
                 cat("\\newpage","\n")    
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
         } else if (ChipType == "TCM") {
             if ((lang == "en") & (disid=="TCM_01_17")) {
                 cat("~\\\\[-4pt]","\n")
             } else if ((lang == "en") && (disid=="TCM_01_08")) {
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
         } else if (ChipType == "COR") {
             if ((lang == "en") & (disid=="COR_01_01" || disid=="COR_01_02" || disid=="COR_01_18" || disid=="COR_01_16")) {
                 cat("~\\\\[-4pt]","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
         ...
         if (ChipType == "PDI"){
             ...
             Ref_URL<-sub("dtect-cardio","dtect-osteoderma",Ref_URL)
         } else if (ChipType == "COR"){
             Ref_URL<-sub("dtect-cardio","dtect-corperate",Ref_URL)
         }
         ...
         if (ChipType == "CRD"){  
             if ((lang == "en") && (disid=="CRD_01_02" || disid=="CRD_01_03" || disid =="CRD_01_11" || 
                  disid =="CRD_01_12")){ 
                  cat("\\newpage","\n")                              
             } else if ((lang == "in" || lang == "ru") && (disid=="CRD_01_02" || disid =="CRD_01_12")){
                  cat("\\newpage","\n")      
             } else if ((lang == "zh"||lang == "ch") && (disid=="CRD_01_01" || disid=="CRD_01_09" || disid=="CRD_01_10" ||
                         disid=="CRD_01_04" || disid=="CRD_01_07" || disid=="CRD_01_14" || disid=="CRD_01_08" ||
                         (disid=="CRD_01_11" && RiskMarkers > 0)||(disid=="CRD_01_12" && RiskMarkers == "2"))) {
                  cat("\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="CRD_01_02")) {                   
                  if (RiskMarkers < 2) {
                      cat("~\\\\","\n")
                      cat("~\\\\[-7pt]","\n")
                  } else {
             ...
             } else if ((lang == "zh"||lang == "ch") && (disid=="CRD_01_12")) {                   
                  if (RiskMarkers < 3) {
                      cat("~\\\\","\n")
                      cat("~\\\\[-7pt]","\n")
                  } else {
             ...
             } else if ((lang == "zh"||lang == "ch") && (disid=="CRD_01_03") && (RiskMarkers == 2)) { 
                  cat("\\newpage","\n") 
             } else if ((lang == "ru") && (disid=="CRD_01_13" && RiskMarkers == 6)){ 
                  cat("\\newpage","\n") 
             } else {
                  cat("~\\\\","\n")
                  cat("~\\\\[-7pt]","\n")
             ...
             if ((lang == "en") && (disid=="PDI_01_01" || disid=="PDI_01_05" || disid=="PDI_01_13" || disid=="PDI_01_02" || 
                 disid=="PDI_01_04" || (disid=="PDI_01_06" && RiskMarkers != "0")|| disid=="PDI_01_09" || 
                 (disid=="PDI_01_07" && RiskMarkers != "0"))){
                 cat("\\newpage","\n")               
             } else if ((lang == "zh"||lang == "ch") && (disid=="PDI_01_05" || disid=="PDI_01_10" || 
                        (disid=="PDI_01_01" && RiskMarkers == "4") || (disid=="PDI_01_04" && RiskMarkers == "4") || 
                        (disid=="PDI_01_13" && RiskMarkers == "1"))) {  
                 cat("\\newpage","\n") 
             } else if ((lang == "in") && (disid=="PDI_01_01" || disid=="PDI_01_02" || 
                        disid=="PDI_01_05" || disid=="PDI_01_06" || disid=="PDI_01_07" || (disid=="PDI_01_09" && RiskMarkers == 3))){
                 cat("\\newpage","\n")
             } else if ((lang == "ru") && (disid=="PDI_01_01" || disid=="PDI_01_05" || disid=="PDI_01_06" || disid=="PDI_01_07")){
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
             ...
             if ((lang == "en") && (disid=="PDC_01_05" || disid=="PDC_01_10"|| disid=="PDC_01_08" || 
                 (disid=="PDC_01_06" && RiskMarkers == 8))){
                 cat("\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="PDC_01_03" || disid=="PDC_01_04" || disid=="PDC_01_05" || 
                        disid=="PDC_01_06" || disid=="PDC_01_07" || (disid=="PDC_01_10" && RiskMarkers > 0) || 
                        (disid=="PDC_01_02" && RiskMarkers > 0) || (disid=="PDC_01_08" && RiskMarkers > 0) || 
                        (disid=="PDC_01_09" && RiskMarkers > 0))){
                 cat("\\newpage","\n")
             } else if ((lang == "in") && (disid=="PDC_01_05" || disid=="PDC_01_08" || disid=="PDC_01_10")){
                 cat("\\newpage","\n")
             } else if ((lang == "ru") && (disid=="PDC_01_08")){
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
             ...
             if ((lang == "en") && (disid=="MTB_01_01" && RiskMarkers != "0")){
                 cat("\\newpage","\n")
             } else if ((lang == "zh" || lang == "ch") && (disid=="MTB_01_13" || disid=="MTB_01_04" || 
                 disid=="MTB_01_12" || disid=="MTB_01_06" || disid=="MTB_01_07" || disid=="MTB_01_08")){
                 cat("\\newpage","\n") 
             } else if ((lang == "zh" || lang == "ch") && (disid=="MTB_01_10")) {
                 if (RiskMarkers > 1) {
                     cat("\\newpage","\n")                   
                 }
             } else if ((lang == "in" || lang == "ru") && (disid=="MTB_01_01")){
                 cat("\\newpage","\n") 
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
             ...
             if (disid == "OST_01_01" || disid == "OST_01_02" || disid == "OST_01_10" || disid=="OST_01_11" || 
                 (disid == "OST_01_03" && RiskMarkers == 4)) 
             {
                 cat("\\newpage","\n")
             } else if ((lang == "en") && (disid=="OST_01_05" && RiskMarkers == 4)) {
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
             ...
             if ((lang == "en") && (disid=="ONC_01_01" || (disid=="ONC_01_30" && PatientGender=="F" && (RiskMarkers > 3 && RiskMarkers < 7)))) {
                 cat("~\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="ONC_01_01" || disid=="ONC_01_02" || disid=="ONC_01_14" || disid=="ONC_01_07" ||
                 disid=="ONC_01_08" || disid=="ONC_01_15" || disid=="ONC_01_21" || disid=="ONC_01_12" || disid=="ONC_01_13" || disid=="ONC_01_19" || 
                 disid=="ONC_01_27" || disid=="ONC_01_29" || (disid=="ONC_01_30" && PatientGender=="F") || disid=="ONC_01_31" || (disid=="ONC_01_28" && PatientGender=="F") || 
                 (disid=="ONC_01_33" && PatientGender=="M") ||(disid=="ONC_01_33" && PatientGender=="F" && (RiskMarkers == 4 || RiskMarkers == 5))|| 
                 (disid=="ONC_01_09" && RiskMarkers > 0)|| (disid=="ONC_01_03" && PatientGender=="M" && (RiskMarkers == 3 || RiskMarkers == 4)))){
                 cat("~\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="ONC_01_25" || disid=="ONC_01_26" || disid=="ONC_01_34" || disid=="ONC_01_10")){
                 cat("~\\\\","\n")
                 cat("~\\\\[-21pt]","\n")
             } else if ((lang == "in") &&(disid=="ONC_01_01" || (disid=="ONC_01_30" && PatientGender=="F" && (RiskMarkers == 3 || RiskMarkers == 4)) || 
                        (disid=="ONC_01_06" && PatientGender=="M" && RiskMarkers == 6) ||
                        (disid=="ONC_01_30" && (RiskMarkers > 3 && RiskMarkers < 7)))){
                 cat("~\\newpage","\n")
             } else if ((lang == "ru") && (disid=="ONC_01_01" || (disid=="ONC_01_30" && (RiskMarkers > 1  && RiskMarkers < 5)) ||
                        (disid=="ONC_01_06" && PatientGender=="M" && (RiskMarkers > 3 && RiskMarkers < 6)))){
                 cat("~\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
             ...
             if ((lang == "en") && (disid=="TCM_01_02" || disid=="TCM_01_03" || disid=="TCM_01_05" || disid=="TCM_01_11" || 
                 disid=="TCM_01_17")){
                 cat("~\\newpage","\n")
             } else if ((lang == "en") && (disid=="TCM_01_07")){
                 cat("~\\\\","\n")
                 cat("~\\\\[-21pt]","\n")
             } else {
                 cat("~\\\\","\n")
             ...
             if ((lang == "en") && ((disid=="COR_01_03" && PatientGender=="M") || (disid=="COR_01_04" && PatientGender=="M") 
                 || (disid=="COR_01_08" && PatientGender=="M") || disid=="COR_01_01" || disid=="COR_01_14" || disid=="COR_01_05")){
                 cat("~\\newpage","\n")
             } else if ((lang == "en") && (disid=="COR_01_02")){
                 cat("~\\\\","\n")
                 cat("~\\\\[-21pt]","\n")
         ...
         if (traitflag != 'N') {
             if (lang=="ru") {
                 cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{1.4cm}|M{2.0cm}|M{2.9cm}|M{1.0cm}|M{2.3cm}|}","\n")
             } else {
                 cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{1.4cm}|M{2.5cm}|M{2.9cm}|M{1.2cm}|M{1.6cm}|}","\n")
             }

             cat("\\hline","\n")
             cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblMarkers_col2_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col3_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col4_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col1_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col7_title,"}} \\\\",sep=""),"\n")
             cat("\\endfirsthead","\n")
             cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblMarkers_col2_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col3_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col4_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col1_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col7_title,"}} \\\\",sep=""),"\n")
         } else {
             if (lang=="ru") {
                 cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{2.5cm}|M{2.5cm}|M{2.0cm}|M{3.0cm}|}","\n")
             } else {
                 cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{2.6cm}|M{3.2cm}|M{2.6cm}|M{1.6cm}|}","\n")
             }

             cat("\\hline","\n")
             cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblMarkers_col2_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col3_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col1_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col7_title,"}} \\\\",sep=""),"\n")
             cat("\\endfirsthead","\n")
             cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblMarkers_col2_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col3_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col1_title,"}} &\\textbf{ \\textcolor{white}{",TblMarkers_col7_title,"}} \\\\",sep=""),"\n")
         }
         ...
         if (length(rowtable) != 0) {
             for (nc in 1:length(rowtable)) {
              ...
              {      
                   ...
                   if ( (traitflag == 'N' && RelativeRisk > 1.00 ) || (traitflag == 'Y' && risktag !=0) )
                   {
                       cat("\\rowcolor{rowcol}","\n")
                       rc<-rc+1
                       rsid<-xmlValue(rowtable[c][["GenoEffect"]][["Genotypes"]][["Genotype"]][["SNP"]]) 
         ...
         if (rc == 0) {
             ...
             if (traitflag != 'N') { 
                 cat(paste("\\multicolumn{5}{|c|}{",No_Variant,"} \\\\",sep=""),"\n")
                  ...
                  cat(paste("\\multicolumn{4}{|c|}{",No_Variant,"} \\\\",sep=""),"\n")  
             }  
             cat("\\hline","\n")
         }
         ...
         if (rc > 0) {
             ...
             if (traitflag != 'N') {
                 cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{1.1 cm}|M{3.3cm}|M{.9cm}|M{2.7cm}|M{1.6cm}|}","\n")
             } else {
                 cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{2.6cm}|M{3.2cm}|M{2.6cm}|M{1.6cm}|}","\n")
             }
         ...
         {
             if (ChipType == "OST") {
                 if ((lang == "en") && (disid == "OST_01_13" || disid == "OST_01_08")) {
                     cat("\\newpage","\n") 
                 } else {
                     cat("\\vspace{-0.1cm}","\n")
                 }                  
             } else if (ChipType == "ONC") {  
                 if ((lang == "en") && ((disid == "ONC_01_18" && RiskMarkers == 7) ||
                     (disid == "ONC_01_04" && PatientGender=="M" && RiskMarkers == 6) || 
                     (disid == "ONC_01_06" && PatientGender=="M" && RiskMarkers == 4) ||
                     (disid == "ONC_01_30" && PatientGender=="F" && RiskMarkers == 1) ||
                     (disid=="ONC_01_03" && PatientGender=="M" && RiskMarkers == 7))) {
                     cat("\\newpage","\n")           
                 } else if (lang == "in" && (disid == "ONC_01_06" && PatientGender=="M" && RiskMarkers == 4)) {
                     cat("\\newpage","\n")
                 } else if ((lang == "ru") && (((disid == "ONC_01_03" || disid == "ONC_01_28" || disid == "ONC_01_29") && 
                            PatientGender=="M" && (RiskMarkers > 2 || RiskMarkers < 6)) ||
                            (disid == "ONC_01_28" && PatientGender=="F" && (RiskMarkers > 4 || RiskMarkers < 8)) || 
                            (disid == "ONC_01_29" && PatientGender=="F" && (RiskMarkers > 3 || RiskMarkers < 7)) ||
                            (disid == "ONC_01_04" && PatientGender=="M" && RiskMarkers == 5))) {
                     cat("\\newpage","\n")
                 } else {
                     cat("\\vspace{-0.1cm}","\n")
                 } 
             } else if (ChipType == "PDC") {             
                 if (lang == "en" && (disid == "PDC_01_06" && RiskMarkers < 8)) {
                     cat("\\newpage","\n") 
                 } else if ((lang == "in") && (disid == "PDC_01_06" && RiskMarkers == 6)) {
                     cat("\\newpage","\n")
                 } else {
                     cat("\\vspace{-0.1cm}","\n")
                 } 
             } else if (ChipType == "PDI") {
                 if ((lang == "zh" || lang == "ch") && ((disid == "PDI_01_06" && RiskMarkers == "1") ||
                     (disid == "PDI_01_07" && RiskMarkers == "1") || disid == "PDI_01_09")){
                      cat("\\newpage","\n")   
                 } else {
                     cat("\\vspace{-0.1cm}","\n")
                 }
             } else if (ChipType == "MTB") {
                 if ((lang == "en") && (disid == "MTB_01_09")){
                      cat("\\newpage","\n")   
                 } else {
                     cat("\\vspace{-0.1cm}","\n")
                 } 
             } else if (ChipType == "TCM") {
                 if ((lang == "en") && ((disid == "TCM_01_01" || disid == "TCM_01_12" || disid == "TCM_01_14"))){
                      cat("\\newpage","\n")   
                 } else {
                     cat("\\vspace{-0.1cm}","\n")
                 } 
...
################################### Section III Image ###################
    ...
    if (lang == "zh"||lang == "ch")
    {
        cat(paste("\\includegraphics[trim=0.25cm 0.2cm 0cm 0cm, clip=true,width=0.3666666\\linewidth]{",Section3,"}",sep=""),"\n")
        cat("~\\\\[-8pt]","\n")
    } else if(lang=="ru"){
        cat(paste("\\includegraphics[trim=0.3cm 0cm 0cm 0cm, clip=true,width=0.6\\linewidth]{",Section3,"}",sep=""),"\n")
        cat("~\\\\[-12pt]","\n")
    } else {
...
################################### Drugs ###################
    ...
    {      
         ...
         drugid<-xmlGetAttr(drugs[i][["Drug"]],"ID")
	 ...
	 DrugTitle<-xmlValue(top[["Titles"]][["DrugTitle"]])       
         ...
         cat(paste("\\fancyhead[OR]{\\begin{mdframed}[linecolor=maincol,roundcorner=0pt,backgroundcolor=maincol,innerleftmargin=0,innertopmargin=4,innerbottommargin=4]\\parbox[t]{1.0\\textwidth}{\\raggedright","\\textbf{ \\textcolor{white}{ \\normalsize ",name,"}}","}\\parbox[t]{0.333\\textwidth}{\\centering Page}\\parbox[t]{0.333\\textwidth}{\\raggedleft 3} \\end{mdframed}}",sep=""),"\n")
         cat(paste("\\fancyhead[EL]{\\begin{mdframed}[linecolor=maincol,roundcorner=0pt,backgroundcolor=maincol,innerleftmargin=0,innertopmargin=4,innerbottommargin=4]\\parbox[t]{1.0\\textwidth}{\\raggedleft","\\textbf{ \\textcolor{white}{ \\normalsize ",name,"}}","}\\parbox[t]{0.333\\textwidth}{\\centering Page}\\parbox[t]{0.333\\textwidth}{\\raggedright 3} \\end{mdframed}}",sep=""),"\n")
...
################################### Pharmacogenetic Markers Table ###################
         ...
         if ((lang == "ru") && (drugid =="CRD_01_20" || drugid=="CRD_01_19" ||  drugid=="CRD_01_16")) {
              cat("\\newpage","\n")
         }
         ...
         if (length(rowtable) != 0) 
	 {
	     ...
	     {    
                  risktag<-xmlGetAttr(rowtable[c][["GenoEffect"]],"risk")
	          genoeffect<-xmlValue(rowtable[c][["GenoEffect"]][["Effect"]])
                  RelativeRisk<-xmlValue(rowtable[c][["GenoEffect"]][["Genotypes"]][["Genotype"]][["RelativeRisk"]])     
              	  if (genoeffect == "*UND") { boolfootflag = 1; }  
        	  if (risktag != "0")  
		  {
                      cat("\\rowcolor{rowcol}","\n")
         ...
         if (rc !=0 )
         {
             if ((lang == "in") && (drugid == "CRD_01_20" || drugid == "CRD_01_19" || (drugid == "CRD_01_16" && RiskMarkers == 1))) {
                cat("\\newpage","\n")
             } else {  
                cat("\\needspace{.9cm}","\n")
             }    
...
name<-xmlValue(top[["Titles"]][["DoctorSummary"]])
...
################################### List Of Useful Terms - Doctor Version ###################
...
#    cat(paste(Formula2,sep=""),"\n")
#    cat("\\begin{IEEEeqnarraybox}{l}","\n")
#    Formula1<-sub("seseorang","seseorang \\}\\} \\\\\\\\ \\\\frac\\{\\\\textit\\{\\\\textrm\\{",Formula1)
#    Formula3<-sub("penduduk","penduduk;",Formula3)
#    array_Formula3<-strsplit(Formula3,";")
#    cat(paste("\\textit{\\textrm{",Formula1,"}}}{ \\textit{\\textrm{",array_Formula3[[1]][1],"}}}",sep=""),"\n")
#    cat("\\end{IEEEeqnarraybox}","\n")
#} else {
#    cat(paste(Formula2," \\frac{ \\textit{\\textrm{",Formula1,"}}}{ \\textit{\\textrm{",Formula3,"}}}\\\\",sep=""),"\n")
#}
...
TblIncreasedRisk_Title<-xmlValue(top[["Summary"]][["IncreasedRiskTable"]][["DoctorTitle"]])
...
if (runtype == 1)
{
    ...
    for (rs in 1:rsize) {
         ...
         Recommendation2<-"" 
         Recommendation3<-"" 
         Recommendation1<-xmlValue(diseases[rs][["Disease"]][["G3Contents"]][["Recommendations"]][["Recommendation1"]])
         Recommendation2<-xmlValue(diseases[rs][["Disease"]][["G3Contents"]][["Recommendations"]][["Recommendation2"]])
         Recommendation3<-xmlValue(diseases[rs][["Disease"]][["G3Contents"]][["Recommendations"]][["Recommendation3"]])
         
         cat(DiseaseID,file="Test.txt",Recommendation3,append=TRUE,"\n")         
         ...
         if (tag == "Disease" )
         {
             ...
             if (SubType_Trait == 'N' ){   
                 if (as.numeric(data[4,rs]) > 1) {
                     ...
                     push(column6,DiseaseID)
                     push(column7,IR)
                     push(column8,Recommendation1)
                     push(column9,Recommendation2)
                     push(column10,Recommendation3)
                 }
             } else {
                 markers<-xmlGetAttr(top[["Diseases"]][rs][["Disease"]][["Profiles"]][["Total"]],"count")
                 if (as.numeric(markers) > 0) {    
    ...
    newdata <- data.frame(col1=column1, col2=column2, col3=column3, col4=column4,col5=column5,col6=column6,col7=column7,col8=column8,col9=column9,col10=column10)
    sorteddata <- newdata[order(newdata$col4,decreasing = TRUE), ]
    ...
    if (nrow(data1) < 7) {
       ...
       if (rowwidth1 < 0.9) { rowwidth1<-0.9}
    }  

    if (nrow(data2) > 1) {
        if (lang == "in") { 
            rowwidth2<-round(5.1/nrow(data2),3)
        } else if (lang=="ru"){
           rowwidth2<-round(4.8/nrow(data2),3)
        } else {
        ...
        if (lang=="ru") {
            rowwidth2<-round(5.3/nrow(data2),3)
        } else {
            rowwidth2<-round(5/nrow(data2),3)
        }
    }
    ...
    if (nrow(data3) < 12) {         
        if (lang == "in" && nrow(data3) == 1) {rowwidth3<-4.6 }
        else { 
            if (lang=="ru") {
                rowwidth3<-as.numeric(round(4.7/nrow(data3),3))
            } else {
        ...
        if (lang=="ru") {
            rowwidth3<-as.numeric(round(4.8/nrow(data3),3))
        } else {
            rowwidth3<-as.numeric(round(4.1/nrow(data3),3))
        }
   
        if(rowwidth3 < 0.9) { rowwidth3<-0.9}
    }

    if (lang == "in"){
        if (nrow(data3) == 12) { 
            rowwidth3<-0.9
        } else if ((nrow(data2) == 2) && (nrow(data3) == 6)) {
            rowwidth3<-1
        } else if (rowwidth3 < 1.2) { 
            rowwidth3<-1.2
        }
    ...
    Note1<-gsub("<br />"," ",Note1)
    Note2<-gsub("<br />"," ",Note2)    
    TblIncreasedRisk_col2_title<-xmlValue(top[["Summary"]][["TypicalAndDecreasedRiskTable"]][["Col2"]])    
    #TblIncreasedRisk_col7_title<-xmlValue(top[["Summary"]][["TypicalAndIncreasedRiskTable"]][["Col7"]])  
    ...
    ptrait<-1
     ...
     if (lang == "zh" || lang == "ch") {
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.2cm}|M{1.7cm}|M{.47cm}|M{5cm}|}","\n")
        } else if (lang == "in"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.1cm}|M{1.37cm}|M{5cm}|}","\n")
        } else if (lang == "ru"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.6cm}|M{.87cm}|M{5cm}|}","\n")
        } else {
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.4cm}|M{1.1cm}|M{.87cm}|M{5cm}|}","\n")
        }
   
        TblIncreasedRisk_col7_title<-xmlValue(top[["Summary"]][["IncreasedRiskTable"]][["Col7"]])
        cat("\\hline","\n")    
        cat(paste("\\rowcolor{textcol} \\textbf{\\textcolor{white}{",TblIncreasedRisk_col1_title,"}}&\\textbf{\\textcolor{white}{",TblIncreasedRisk_col2_title,"}}&\\textbf{ \\textcolor{white}{",TblIncreasedRisk_col6_title,"}} &\\textbf{ \\textcolor{white}{",TblIncreasedRisk_col7_title,"}}\\\\",sep=""),"\n")
        cat("\\endfirsthead","\n")
    ...
    if (nrow(data1) != 0 ){
          for (rs in 1:nrow(data1)) {     
                 cat("\\rowcolor[RGB]{243,189,185}","\n")                  
                 cat(paste(data1[rs,1],"& ", data1[rs,4] ,"&",data1[rs,5] ,"&\\parbox[t]{5cm}{", data1[rs,10] ,"~\\\\[-5pt]}\\\\",sep=""),"\n") 
                 cat("\\hline","\n")             
            }       
    } 
    ...
    if (nrow(data2) != 0 ){
          for (rs in 1:nrow(data2)) {     
                 cat("\\rowcolor[RGB]{251,204,157} ")                  
                 cat(paste(data2[rs,1],"& ", data2[rs,4] ,"&",data2[rs,5] ,"&\\parbox[t]{5cm}{", data1[rs,9] ,"~\\\\[-5pt]}\\\\",sep=""),"\n") 
                 cat("\\hline","\n")             
            }     
    } 
     ...
     if (nrow(data3) != 0 ){
          for (rs in 1:nrow(data3)) {     
                  cat("\\rowcolor[RGB]{255,255,51} ")                   
                 cat(paste(data3[rs,1],"& ", data3[rs,4] ,"&",data3[rs,5] ,"&\\parbox[t]{5cm}{", data1[rs,8] ,"~\\\\[-5pt]}\\\\",sep=""),"\n") 
                 cat("\\hline","\n")             
            }    
    }
    cat("\\end{longtable}}","\n")
    ...
    if ((nrow(sorteddata) + nrow(sorteddata_trait))!= 0 )
    {
        ...
        if (lang == "zh" || lang == "ch") {
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.2cm}|M{1.7cm}|M{.47cm}|}","\n")
        } else if (lang == "in"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.1cm}|M{1.37cm}|}","\n")
        } else if (lang == "ru"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.6cm}|M{.87cm}|}","\n")
...
{ 
                ...
                for (rs in 1:tmax)
                {
                     if (sorteddata_trait[rs,3] != "0" )
                     {
                         if((nrow(data3)+count) < 9) {                  
                             ...
                             if (lang == "in" && ChipType == "PDC" && (sorteddata_trait[rs,6] == "PDC_01_10")) { this_rowwidth<-1.088 }
                             else if(lang=="ru") {this_rowwidth<-1.041} 
                             else { this_rowwidth<-1.008 }
        ...
        if (lang == "en" || lang == "in") {
            ...
            totalwidth<-rowwidth1*nrow(data1) + 0.2844*(nrow(data1)-1)
        } else {
            totalwidth<-rowwidth1*nrow(data1) + 0.2318*(nrow(data1)-1)
        }
        ...
        if (lang == "en" || lang == "in") {   
            ...
            totalwidth<-rowwidth2*nrow(data2) + 0.2844*(nrow(data2)-1)
        } else {
            totalwidth<-rowwidth2*nrow(data2) + 0.2318*(nrow(data2)-1)
        }
                ...
                for (rs in 1:tmax) { 
                     if (sorteddata_trait[rs,3] != "0" )
                     {
                         if((nrow(data3)+count) < 9) {                            
                            ...
                            if (lang == "in" && ChipType == "PDC" && (sorteddata_trait[rs,6] == "PDC_01_10")) { this_rowwidth<-1.088 }
                            else if (lang=="ru") {this_rowwidth<-1.058}
                            else if(lang=="en" && ChipType == "OST") {this_rowwidth<-1.015}
                            else { this_rowwidth<-1.008 }
        ...
        {    
            ...
            if (lang == "en" || lang == "in" || lang == "ru") {   
                ...
                if (lang == "ru") { totalwidth<-rowwidth3*nrow(data3) + 0.28*(nrow(data3)-1) }
                else { totalwidth<-rowwidth3*nrow(data3) + 0.2744*(nrow(data3)-1) }
            } else {   
                cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblIncreasedRisk_col3_title,"}} \\\\[0.39cm]",sep=""),"\n")
                cat("\\endfirsthead","\n")
                cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblIncreasedRisk_col3_title,"}} \\\\[0.39cm]",sep=""),"\n")
            ...
            if (nrow(sorteddata_trait) != 0 )
            {
                for (rs in traitstart:traitcount) {            
                     ...
                     {    
                         count_risk_markers<-sub("\\$\\{count\\}",sorteddata_trait[rs,3],count_risk_markers_Tmp)
                         if (lang=="en" && ChipType == "OST") {this_rowwidth<-1.015}
                         else {this_rowwidth<-1.008}
                         #cat(paste("\\parbox[t][",this_rowwidth,"cm]{4.5cm}{\\textcolor{black}{","\\cellcolor{rowcol}",count_risk_markers,"}}\\\\",sep=""),"\n")
                         #cat("\\hline","\n")
                     }   
   ...
   ###############################################################################################################################################################
       ...
       if (lang == "zh" || lang == "ch") {
           cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.2cm}|M{1.7cm}|M{.47cm}|M{4cm}|}","\n")
       } else if (lang == "in"){
           cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.1cm}|M{1.37cm}|M{4cm}|}","\n") 
       }  else if (lang == "ru"){
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.6cm}|M{.87cm}|}","\n")
       } else {
...
if (runtype == 1)
{
          ...
          if (tag == "Disease" ) 
          {
              ...
              if (SubType_Trait == 'N'){ 
                  if (as.numeric(data[4,rs]) <= 1) {
                      ...
                      } else if (lang == "ru" && ChipType == "MTB") {
                          if (DiseaseID == "MTB_01_01") {
                              disname<-"курения на метабо - лический синдром"
                          }
                      } else if (lang == "en" && ChipType == "PDC") {
                          if (DiseaseID == "PDC_01_03"){
                              disname<-sub("\\(ADHD\\)", "",disname) 
    ...
    if (nrow(sorteddata_disease) > 3) {
        if (lang == "in" && (ChipType == "CRD")) {             
            typicalsortedrowwidth<-8.5/nrow(sorteddata)
        } else if (lang == "in" && (ChipType == "MTB")) {             
            typicalsortedrowwidth<-8.048/nrow(sorteddata)
        } else {
        ...
        if (ChipType == "CRD") {
            ...
            typicalsortedrowwidth<-7.1/nrow(sorteddata)           
        }     
    }
    
    if (lang == "in" && ChipType == "CRD"){
        if (typicalsortedrowwidth < 1.04) { typicalsortedrowwidth<-1.04 }
    } else {
        if (typicalsortedrowwidth < 1) { typicalsortedrowwidth<-1 }
    }
    ...
    if (nrow(sorteddata) != 0 )
    {
        ...
        for (rs in 1:disease_count) {
              if (sorteddata[rs,2] == "0") {
                 traits<-1
                 cat("\\rowcolor{rowcol}","\n") 
                 #cat(paste("\\parbox[t][1.008cm]{",colwidth1,"cm}{\\raggedright ",sorteddata[rs,1],"} & ", "N/A" ,"&",sorteddata[rs,5]   ,"\\\\",sep=""),"\n") 
                 #cat("\\hline","\n")
             } else {             
                cat(paste("\\parbox[t][",typicalsortedrowwidth,"cm]{",colwidth1,"cm}{\\raggedright ",sorteddata[rs,1],"}","& ", sorteddata[rs,4], "& ", sorteddata[rs,5],"\\\\",sep=""),"\n")
                cat("\\hline","\n") 
             }
        }
    }
    ...
    if (lang == "en" || lang == "in" || lang == "ru") {
        ...
        cat(paste("\\rowcolor{textcol}\\textbf{\\textcolor{white}{",tblTypicalAndDecreasedRisk_col3_title,"}} \\\\[0.39cm]",sep=""),"\n")
    } 
    ...
    if (ChipType == "CRD"){ 
        if (lang == "en") {
            ...
            totalwidth<-typicalsortedrowwidth*maxrows + 0.2748*(maxrows-1)
        } else if (lang == "ru") {
            totalwidth<-typicalsortedrowwidth*maxrows + 0.2844*(maxrows-1)
        } else {
            totalwidth<-typicalsortedrowwidth*maxrows + 0.2318*(maxrows-1)
        }                  
    } else {
        if (lang == "en"){  
            totalwidth<-typicalsortedrowwidth*maxrows + 0.2733*(maxrows-1) 
        } else if (lang == "in") {  
            totalwidth<-typicalsortedrowwidth*maxrows + 0.2728*(maxrows-1)
        } else if (lang == "ru") {
            totalwidth<-typicalsortedrowwidth*maxrows + 0.28*(maxrows-1)
        } else {
            totalwidth<-typicalsortedrowwidth*maxrows + 0.2318*(maxrows-1)
        } 
    }
        ...
        { 
            for (rs in (maxrows+1):maxtraitrows) {
                 ...
                 if (sorteddata[rs,2] == "0") {
                     ...
                     if(lang=="ru") {
                       #cat(paste("\\parbox[t][1.018cm]{4.5cm}{\\textcolor{black}{","\\cellcolor{rowcol}",no_risk_markers,"}}\\\\",sep=""),"\n")
                     } else {
                       # cat(paste("\\parbox[t][1.008cm]{4.5cm}{\\textcolor{black}{","\\cellcolor{rowcol}",no_risk_markers,"}}\\\\",sep=""),"\n")
                     }
                     cat("\\hline","\n")
                 }             
            }
    ...
    if (no_of_diseases > 10)
    {
        ...
        if (lang == "in" && ChipType == "CRD"){
            if (typicalsortedrowwidth < 1.2) { typicalsortedrowwidth<-1.2 }
        } else {
           if (typicalsortedrowwidth < 1) { typicalsortedrowwidth<-1 }
        }
        ...
        if (nrow(sorteddata) != 0 ) {        
            ...
            for (rs in (disease_count+1):maxrange) {
                 if (sorteddata[rs,2] == "0") {
                     traits<-1
                     cat("\\rowcolor{rowcol}","\n") 
                     #cat(paste("\\parbox[t][1cm]{",colwidth1,"cm}{\\raggedright ",sorteddata[rs,1],"} & ", "N/A" ,"&",sorteddata[rs,5]   ,"\\\\",sep=""),"\n")
                     #cat("\\hline","\n")  
                 } else {             
                     disflag<-1
                     cat(paste("\\parbox[t][",typicalsortedrowwidth,"cm]{",colwidth1,"cm}{\\raggedright ",sorteddata[rs,1],"} & ", sorteddata[rs,4], "& ", sorteddata[rs,5],"\\\\",sep=""),"\n")
        ...
        if (lang == "en" || lang == "in" || lang == "ru") {
            ...
            cat("\\endhead","\n")        
        #} else if (lang == "ru") {
        #    cat(paste("\\rowcolor{textcol}\\textbf{\\textcolor{white}{",tblTypicalAndDecreasedRisk_col3_title,"}} \\\\[0.78cm]",sep=""),"\n")
        #    cat("\\endfirsthead","\n")
        #    cat(paste("\\rowcolor{textcol}\\textbf{\\textcolor{white}{",tblTypicalAndDecreasedRisk_col3_title,"}} \\\\[0.78cm]",sep=""),"\n")
        #    cat("\\endhead","\n")
        } else {
        ...
        if (lang == "en"){
            totalwidth<-typicalsortedrowwidth*cnt + 0.2733*(cnt-1) #0.2744

            if ((ChipType == "COR") && (cnt == 4)) {
                totalwidth<-5.1    
            }   
        } else if (lang == "in") {
            totalwidth<-typicalsortedrowwidth*cnt + 0.2728*(cnt-1)             
        } else if(lang == "ru") {
            totalwidth<-typicalsortedrowwidth*cnt + 0.28*(cnt-1) 
        } else {
            totalwidth<-typicalsortedrowwidth*cnt + 0.2318*(cnt-1) 
        }
    ...
    if (no_of_diseases > 21)
    {
        ...
        if (lang == "zh" || lang == "ch") {
            ...
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.9cm}|M{1.6cm}|M{0.87cm}|}","\n")
        } else {
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.4cm}|M{1.1cm}|M{.87cm}|}","\n")
        }
        ...
        if ((remaining_diseases+nrow(sorteddata_trait)) < 11)
        {
            ...
            if (nrow(sorteddata_trait) != 0 )
            {
                for (rs in 1:nrow(sorteddata_trait)) {
                     if (sorteddata_trait[rs,2] == "0" ) {
                         cat("\\rowcolor{rowcol}","\n") 
                         #cat(paste("\\parbox[t][1.008cm]{",colwidth1,"cm}{\\raggedright ",sorteddata_trait[rs,1],"} & ", "N/A" ,"&",sorteddata_trait[rs,5]   ,"\\\\",sep=""),"\n") 
                         #cat("\\hline","\n")
                     }
                }
            }
        ...
        if (lang == "en"){   
           totalwidth<-typicalsortedrowwidth*cnt + 0.2733*(cnt-1)  
        } else if (lang == "in") {
            totalwidth<-typicalsortedrowwidth*cnt + 0.2728*(cnt-1)
        } else if (lang == "ru") {
            totalwidth<-typicalsortedrowwidth*cnt + 0.28*(cnt-1) 
