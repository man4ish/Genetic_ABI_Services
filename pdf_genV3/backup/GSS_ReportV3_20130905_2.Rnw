...
GenGRRPlot <- function(IR,Gender,GRR, AvGRR, Interval, name, DiseaseID, age ) {              #new function added for plot generation
    ...
    pdf(paste("./tmp/",DiseaseID,".pdf",sep=""),width=10,height=7.8)     #this path and/or name need to changed
...
if (runtype == 1)
{
    ...
    rowwidth1<-round(2/nrow(data1),1)
    rowstart1<-rowwidth1-0.8
    cat(paste("\\newcommand{\\dsr}{\\rule[-",rowstart1,"cm]{0pt}{",rowwidth1,"cm}}",sep=""),"\n")

    rowwidth2<-round(3/nrow(data2),1)
    rowstart2<-rowwidth2-0.8
    cat(paste("\\newcommand{\\nsr}{\\rule[-",rowstart2,"cm]{0pt}{",rowwidth2,"cm}}",sep=""),"\n")


    rowwidth3<-round(5/nrow(data3),1)
    rowstart3<-rowwidth3-0.6
    cat(paste("\\newcommand{\\psr}{\\rule[-",rowstart3,"cm]{0pt}{",rowwidth3,"cm}}",sep=""),"\n")

    cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|P{3.4cm}|M{1.0cm}|P{4.0cm}|P{0.8cm}|}","\n")
    cat("\\hline","\n")
   

    cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",TblIncreasedRisk_col1_title,"}} &\\textbf{ \\textcolor{white}{",TblIncreasedRisk_col2_title,"}} &\\textbf{ \\textcolor{white}{",TblIncreasedRisk_col3_title,"}}  &\\textbf{ \\textcolor{white}{",TblIncreasedRisk_col6_title,"}} \\\\",sep=""),"\n")
    cat("\\endfirsthead","\n")
    ...
    if (nrow(data1) != 0 )
    {
        for (rs in 1:nrow(data1)) {
             ...
             cat(paste( data1[rs,1]," &  ",data1[rs,4]))

             ###########################Manish Change######################################
             IR<-data1[rs,7]
             AvGRR<-mean(as.numeric(riskfile[[data1[rs,6]]]))
             GRR<-as.numeric(as.character(data1[rs,4]))
             ...
             if(rs == nrow(data1)){    
                 cat(paste("&  \\multirow{-",nrow(data1),"}{*}{\\parbox{4.0cm}{\\textcolor{black}{",Note1,"}}}",sep=""),"\n") 
             }
             else {
                cat(paste("& ", " ",sep=""),"\n")
             }

             cat(paste("& \\dsr ","\\cellcolor{red!25}",data1[rs,5],"\\\\\\cline{1-2} \\cline{4-4}",sep=""),"\n")
        }
        cat("\\hline","\n") 
    }
    ...
    if (nrow(data2) != 0 )
    {
        ...
        for (rs in 1:nrow(data2)) {
             ...
             cat(paste(" ", data2[rs,1]," &  ",data2[rs,4]))
             ###########################Manish Change######################################
             IR<-data2[rs,7]
             AvGRR<-mean(as.numeric(riskfile[[data2[rs,6]]]))
             GRR<-as.numeric(as.character(data2[rs,4]))
             disease_name<-data2[rs,1] 
             ...
             if (rs == nrow(data2)){                
                 cat(paste("&  \\multirow{-",nrow(data2)+2,"}{*}{\\parbox{4.0cm}{\\textcolor{black}{",Note2,"}}}",sep=""),"\n") 
             }
             else {
                cat(paste(" & ", " ",sep=""),"\n")
             }

             cat(paste("& \\nsr ","\\cellcolor{yellow!25}",data2[rs,5],"\\\\\\cline{1-2} \\cline{4-4}",sep=""),"\n")
        }
        cat("\\hline","\n") 
    }
    ...
    if (nrow(data3) != 0 )
    {
        ...
        for (rs in 1:nrow(data3)) {
             ...
             cat(paste(" ", data3[rs,1]," &  ",data3[rs,4]))
             ###########################Manish Change######################################
             IR<-data3[rs,7]
             AvGRR<-mean(as.numeric(riskfile[[data3[rs,6]]]))
             GRR<-as.numeric(as.character(data3[rs,4]))
             ...
             if (rs == nrow(data3)){                
                 cat(paste("&  \\multirow{-",nrow(data3)+2,"}{*}{\\parbox{4.0cm}{\\textcolor{black}{",Note3,"}}}",sep=""),"\n")   #chnage it to Note3
             }
             else {
                cat(paste(" & ", " ",sep=""),"\n")
             }

             cat(paste("& \\psr ","\\cellcolor{yellow!25}",data3[rs,5],"\\\\\\cline{1-2} \\cline{4-4}",sep=""),"\n")
        }
        cat("\\hline","\n") 
    }
    ...
    if (nrow(sorteddata_trait) != 0 )
    {
        for (rs in 1:nrow(sorteddata_trait)) {
             ...
             if (sorteddata_trait[rs,3] != "0" ) { 
                 ...
                 cat(paste("& ",count_risk_markers,sep=""),"\n") 
             }
             else {
                 cat(paste("& ",no_risk_markers,sep=""),"\n")
             }
...
if (xmlSize(diseases) !=0)
{
    ...
    {       
         ...
         if (traitflag == 'N') {  
             ...
             disname<-name
             IR<-as.numeric(xmlValue(top[["Summary"]][["Results"]][i][["Result"]][["Incidence"]]))
             ...
             cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{1.6cm}|M{1.5cm}|M{1.9cm}|M{5.0cm}|}","\n")
             cat(paste("\\rowcolor{textcol} & \\textbf{ \\textcolor{white}{",TblGenetic_col1_title,"}} & \\textbf{ \\textcolor{white}{",TblGenetic_col2_title,"}} & \\textbf{ \\textcolor{white}{",TblGenetic_col3_title,"}}\\\\",sep=""),"\n")
             ...
             if (AvGLR != 1) {
                 if(GRR >= 2) {
                    cat(paste("\\textbf{\\textcolor{black}{ \\srrRowOne ",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", AvGLR,"\\%}} & \\textbf{\\textcolor{black}{", GLR, "\\%}} & \\\\",sep=""),"\n")
                 } else if(GRR > 1.0 && GRR < 1.5) {
                    cat(paste("\\textbf{\\textcolor{black}{ \\srrRowTwo ",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", AvGLR,"\\%}} & \\textbf{\\textcolor{black}{", GLR, "\\%}} & \\\\",sep=""),"\n") 
                 } else {  
                    cat(paste("\\textbf{\\textcolor{black}{ \\srr ",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", AvGLR,"\\%}} & \\textbf{\\textcolor{black}{", GLR, "\\%}} & \\\\",sep=""),"\n")
                 } 
             } else {
                 if(GRR >= 2) {
                    cat(paste("\\textbf{\\textcolor{black}{ \\srrRowOne ",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", AvGLR,".00\\%}} & \\textbf{\\textcolor{black}{", GLR, "\\%}} & \\\\",sep=""),"\n")
                 } else if(GRR > 1.0 && GRR < 1.5) {
                    cat(paste("\\textbf{\\textcolor{black}{ \\srrRowTwo ",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", AvGLR,".00\\%}} & \\textbf{\\textcolor{black}{", GLR, "\\%}} & \\\\",sep=""),"\n") 
                 } else {                   
                    cat(paste("\\textbf{\\textcolor{black}{ \\srr ",TblGenetic_row1_title,"}} & \\textbf{\\textcolor{black}{", AvGLR,".00\\%}} & \\textbf{\\textcolor{black}{", GLR, "\\%}} &  \\\\",sep=""),"\n")
                 }
             }             
             ...
             if(GRR >= 2)
             {
               cat(paste("\\rowcolor{rowcol} \\textbf{\\textcolor{black}{",TblGenetic_row2_title,"}}  & \\textbf{\\textcolor{black}{", round(AvGRR,2),"}} & \\textbf{\\textcolor{black}{",data[5,i],"}} & \\multirow{-4}{*}{\\parbox{5.0cm}{",Note1,"}}\\\\",sep=""),"\n")
 
              #Note<-Note1
             } else if(GRR > 1.0 && GRR < 1.5) {
               cat(paste("\\rowcolor{rowcol} \\textbf{\\textcolor{black}{",TblGenetic_row2_title,"}}  & \\textbf{\\textcolor{black}{", round(AvGRR,2),"}} & \\textbf{\\textcolor{black}{",data[5,i],"}} & \\multirow{-3}{*}{\\parbox{5.0cm}{",Note2,"}}\\\\",sep=""),"\n")

               #Note<-Note2
             }
             else
             {
               cat(paste("\\rowcolor{rowcol} \\textbf{\\textcolor{black}{",TblGenetic_row2_title,"}}  & \\textbf{\\textcolor{black}{", round(AvGRR,2),"}} & \\textbf{\\textcolor{black}{",data[5,i],"}} & \\multirow{-5}{*}{\\parbox{5.0cm}{",Note3,"}}\\\\",sep=""),"\n")
             ...
             if (file.exists(ImageFile)) {
                 ...
                 cat("\\begin{mdframed}[linecolor=black,roundcorner=0pt,innerleftmargin=10,innertopmargin=0,innerbottommargin=0,innerrightmargin=0,everyline = true, outerlinewidth=0.1, splittopskip=1cm, splitbottomskip=.5cm]","\n")
                 cat("\\begin{center}","\n")
                 #cat(paste("\\includegraphics[trim=1cm 0.4cm 0cm 16.0cm, clip=true,width=0.9\\linewidth]{",ImageFile,"}",sep=""),"\n")
                 cat(paste("\\includegraphics[trim=1cm 0.5cm 0cm 18cm, clip=true,width=0.9\\linewidth]{",ImageFile,"}",sep=""),"\n")
                 cat("\\end{center}","\n")
                 cat("\\end{mdframed}","\n")
            } 
...
################################### Disease's Symptoms ###################
         ...
         if (Text != ""){    
             ...
             if (ChipType == "CRD") {
                 ...
                 if (disid == "CRD_01_09") { cat("~\\\\[-0.5pt]","\n") }
             }
             else if (ChipType == "PDI") {
                 if (disid != "PDI_01_09") { cat("~\\\\","\n") }
                 cat("~\\\\","\n")  
             }         
             else {
                 cat("~\\\\","\n")
...
################################### Disease's Prevention ###################
         ...
         if (disid=="CRD_01_04") {
             ...
             if (disid=="PDI_01_02" || disid=="PDI_01_04" || disid=="PDI_01_10"){
                 cat("~\\\\[-15pt]","\n")  
             } else {
                 cat("~\\\\[-4pt]","\n")  
             }    
         } else if (ChipType == "PDC"){   
             if (disid=="PDC_01_03" || disid=="PDC_01_04" || disid=="PDC_01_07" || disid=="PDC_01_10") {
                 cat("~\\\\[-4pt]","\n")
             } else if (disid=="PDC_01_06" || disid=="PDC_01_08") {
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
...
################################### Risk Markers Table ###################   
         ...
         if (ChipType == "CRD"){  
             if (disid=="CRD_01_03" || disid =="CRD_01_11" || disid =="CRD_01_12" || disid =="CRD_01_14") 
             { 
                cat("\\newpage","\n")                
             } 
         }  
         else if (ChipType == "PDI"){
             if (disid=="PDI_01_01" || disid=="PDI_01_05" || disid=="PDI_01_13" || disid=="PDI_01_07" || disid=="PDI_01_10"){
                 cat("\\newpage","\n")               
             }else if (disid=="PDI_01_02"){
                 cat("~\\\\","\n")  
             ...
             if (disid=="PDC_01_02" || disid=="PDC_01_04" || disid=="PDC_01_05" || disid=="PDC_01_10"|| disid=="PDC_01_09"){
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
...
cat(paste("\\begin{minipage}{0.7\\linewidth}","\n"))
cat(paste("\\raggedleft \\scriptsize \\textcolor{red} {",TearOffInstruction,"}" ,sep=""),"\n")
cat("\\end{minipage}","\n")
...
#SubTitle3<-sub("<=","\\\\begin\\{equation*\\} \\\\boldsymbol\\{\\\\leq\\} \\\\end\\{equation*\\}",SubTitle3)
#SubTitle3<-sub("<=","\\\\boldsymbol\\{\\\\leq\\}",SubTitle3)
#SubTitle3<-sub("<=","\\} \\\\boldsymbol\\{\\\\leq\\} \\\\textbf{",SubTitle3)
...
if (runtype == 1)
{
    ...
    rowwidth1<-round(4/nrow(data1),1)
    rowstart1<-rowwidth1-.5
    cat(paste("\\newcommand{\\docdsr}{\\rule[-",rowstart1,"cm]{0pt}{",rowwidth1,"cm}}",sep=""),"\n")

    rowwidth2<-round(6/nrow(data2),1)
    rowstart2<-rowwidth2-.5
    cat(paste("\\newcommand{\\docnsr}{\\rule[-",rowstart2,"cm]{0pt}{",rowwidth2,"cm}}",sep=""),"\n")

    rowwidth3<-round(6/nrow(data3),1)
    rowstart3<-rowwidth3-.5
    cat(paste("\\newcommand{\\psrr}{\\rule[-",rowstart3,"cm]{0pt}{",rowwidth3,"cm}}",sep=""),"\n")

    cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|P{3.4cm}|M{1.0cm}|P{4.0cm}|P{0.8cm}|}","\n")
    cat("\\hline","\n")
   
    DoctorNote1<-xmlValue(top[["Summary"]][["IncreasedRiskTable"]][["DoctorNote1"]])
    DoctorNote1<-sub("\\$\\{symbol_ge\\}",">=",DoctorNote1)   
    
    DoctorNote2<-xmlValue(top[["Summary"]][["IncreasedRiskTable"]][["DoctorNote2"]])   
    DoctorNote3<-xmlValue(top[["Summary"]][["IncreasedRiskTable"]][["DoctorNote3"]])
    ...
    if (nrow(data1) != 0 )
    {
        for (rs in 1:nrow(data1)) {
             ...
             if(rs == nrow(data1)){    
                 cat(paste("&  \\multirow{-",nrow(data1)-1,"}{*}{\\parbox{4.0cm}{\\textcolor{black}{",DoctorNote1,"}}}",sep=""),"\n")            
             }
             else {
                cat(paste("& ", " ",sep=""),"\n")
             }
    ...
    if (nrow(data2) != 0 )
    {
        for (rs in 1:nrow(data2)) {
             ...
             if(rs == nrow(data2)){                
                 cat(paste("&  \\multirow{-",nrow(data2)+3,"}{*}{\\parbox{4.0cm}{\\textcolor{black}{",DoctorNote2,"}}}",sep=""),"\n")
             }
             else {
                cat(paste(" & ", " ",sep=""),"\n")
             }
    ...
    {       
        for (rs in 1:nrow(data3)) {
             ...
             if (rs == nrow(data3)){                
                 cat(paste("&  \\multirow{-",nrow(data3)+2,"}{*}{\\parbox{4.0cm}{\\textcolor{black}{",DoctorNote3,"}}}",sep=""),"\n")   #chnage it to Note3
             }
             else {
                cat(paste(" & ", " ",sep=""),"\n")
             }

             cat(paste("& \\psrr ","\\cellcolor{yellow!25}",data3[rs,5],"\\\\\\cline{1-2} \\cline{4-4}",sep=""),"\n")
        }
        cat("\\hline","\n") 
    }
...
if (runtype == 1)
{
    ...
    ##############################  Manish Added ########################################################################
    rowwidth<-round(5/nrow(sorteddata),1)
    if(rowwidth < .5)
    {
       rowwidth<-.5
    }
    rowstart<-rowwidth-.5
    cat(paste("\\newcommand{\\doctsr}{\\rule[-",rowstart,"cm]{0pt}{",rowwidth,"cm}}",sep=""),"\n")
    ######################################################################################################################

    cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|P{3.2cm}|M{1.4cm}|P{3.8cm}|P{0.8cm}|}","\n")

    cat("\\hline","\n")
    cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col1_title,"}} &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col2_title,"}} &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col3_title,"}}  &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col6_title,"}} \\\\",sep=""),"\n")
    cat("\\endfirsthead","\n")
    ...
    if (nrow(sorteddata) != 0 )
    {
        ...
        for (rs in 1:nrow(sorteddata)) {
             ...
             AvGRR<-as.numeric(xmlValue(risktop[[disease_id]]))
             ...
             ################################################# Mansih Added ########################################################################
             if(rs == nrow(sorteddata)){
                 cat(paste("&  \\cellcolor{white}{\\multirow{-",nrow(sorteddata)+3,"}{*}{\\parbox{4.0cm}{\\textcolor{black}{",Note,"}}}}",sep=""),"\n")
             }
             else {
                cat(paste("& ", "\\cellcolor{white}{} ",sep=""),"\n")
             } 
             #####################################################################################################################################
             cat(paste("& ","\\doctsr ","\\cellcolor{white}", sorteddata[rs,5],"\\\\\\cline{1-2} \\cline{4-4}",sep=""),"\n")   
        }
    }
