...
if (runtype == 1)
{
    diseaseindexfile<-read.csv("GSS_ReportV3_manish.disindex",sep="^",quote="\"",header=F)
    indexmap=list()
    ...
    newdata_trait <- data.frame(col1=column1_trait, col2=column2_trait, col3=column3_trait, col4=column4_trait,col5=column5_trait)
    ...
    if (nrow(sorteddata) != 0 )
    {
        ...
        for (rs in 1:nrow(sorteddata)) {
             ...
             if (R_Type == '1' ){#(as.numeric(as.character(sorteddata[rs,4])) > 2.00) {                                       
                 cat(paste(" & \\multirow{1}{*}{\\textcolor{black} \\tiny Note1} & - & - & ",sorteddata[rs,5]," \\\\",sep=""),"\n")
                 #cat(paste(" & \\multirow{1}{*}{\\minitab[l]{\\textcolor{black} \\tiny ",Note1,"}} & - & - & ",sorteddata[rs,5]," \\\\",sep=""),"\n")
                 R_Type<-'9' 
             } else if (R_Type == '2' ){                 
                 cat(paste(" & \\multirow{3}{*}{\\textcolor{black} \\tiny Note2} & - & - & ",sorteddata[rs,5]," \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")        
                 #cat(paste(" & \\multirow{3}{*}{\\minitab[l]{\\textcolor{black} \\tiny ",Note2,"}} & - & - & ",sorteddata[rs,5]," \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")
                 #cat(paste(" & \\multirow{3}[6]{*}{\\minitab[l]{\\textcolor{black} \\tiny ",Note2,"}} & - & - & ",sorteddata[rs,5],"\\bigstrut \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")
                 #cat(paste(" & \\multirow{3}{*}{\\textcolor{black} \\tiny{Type-2}} &   &   & ",sorteddata[rs,5]," \\\\",sep=""),"\n")

                 R_Type<-'8' 
             } else {
                 cat(paste(" & & - & - & ",sorteddata[rs,5]," \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")
                 #cat(paste(" & & - & - & ",sorteddata[rs,5],"\\bigstrut \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")
             }      
        }
        cat("\\hline","\n") 
    }
...
if (ChipType=="CRD" && runtype == 1)
{
     ...
     cat("~\\\\","\n")
      ...
      drugsummaryfile<-read.csv("GSS_ReportV3_manish.comment",sep="'",header=F)
...
cat("\\begin{mdframed}[linecolor=red,roundcorner=0pt,innerleftmargin=10,innertopmargin=5,innerbottommargin=10,innerrightmargin=10,everyline = true, outerlinewidth=2, splittopskip=1cm, splitbottomskip=.5cm]","\n")
...
cat("{\\begin{longtable}{P{1.4cm}P{10.2cm}}","\n")
cat(paste("  & ",Formula1,"\\\\",sep=""),"\n")
cat(paste("\\normalsize ",Formula2," & \\begin{flushleft} \\linethickness{1mm} \\line(1,0){268} \\end{flushleft} \\\\",sep=""),"\n") #\\textemdas
...
################################### Number of Risk Markers Detected ###################
         ...
         cat(paste("\\fbox{\\begin{minipage}{0.68\\linewidth}","\n"))
         #cat("\\begin{center}")
         cat(paste("\\footnotesize \\textbf {", NumberOfRiskMarkers, "}" ,sep=""),"\n") 
         #cat("\\end{center}")
         cat("\\end{minipage}}","\n")
...
################################### Genetic Table ###################
         ...
         #else { SubType_Trait<-xmlGetAttr(top[["Summary"]][["Results"]][i][["Result"]],"Subtype") }
         ...
         if (traitflag == 'N') {  
             ...
             cat("\\hline","\n")
             cat(paste("\\rowcolor{rowcol} \\textbf{ \\textcolor{black}{",TblGenetic_row1_title,"}} & & \\textbf{ \\textcolor{black}{",data[5,i],"}} \\\\",sep=""),"\n")
             cat("\\hline","\n")
             cat(paste("\\rowcolor{rowcol} \\textbf{ \\textcolor{black}{",TblGenetic_row2_title,"}} & & \\\\",sep=""),"\n")
             cat("\\hline","\n")
             cat("\\end{longtable}}","\n")
         } else {
             cat("~\\\\","\n")
...
################################### Risk Markers Table ###################   
         ...
         cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{1.4cm}|M{1.4cm}|M{1.4cm}|M{2.4cm}|M{1.2cm}|M{1.3cm}|}","\n")
         cat("\\hline","\n")
...
################################### Individual Drug ###################
         ...
         cat(paste("\\begin{minipage}{0.17\\linewidth}","\n"))
      	 ...
      	 cat(paste("\\fbox{\\begin{minipage}{0.68\\linewidth}","\n"))
         #cat("\\begin{center}")
         cat(paste("\\footnotesize \\textbf {",NumberOfPharmacogeneticMarkers,"}",sep= ""), "\n")   
         #cat("\\end{center}")
       	 cat("\\end{minipage}}","\n")
