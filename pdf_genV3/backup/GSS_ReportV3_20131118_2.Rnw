...
if ((ChipType == "MTB" && lang == "en")||(ChipType == "CRD" && lang == "in")) {
    cat("\\begin{center}","\n")
...
if (xmlSize(diseases) !=0)
{
    ...
    {       
         ...
         if (Text != ""){    
             ...
             } else if ((lang == "en") && (disid=="MTB_01_05")){
                 cat("~\\\\","\n")
                 cat("~\\\\[10pt]","\n")  
             } else if ((lang == "in") && (disid=="CRD_01_08" || disid=="CRD_01_06" )){ 
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\","\n")
...
#}
         ...
         if (ChipType == "CRD"){  
             ...
             if ((lang == "en") && (disid=="MTB_01_11" || disid=="MTB_01_08")) {
                 cat("\\newpage","\n")               
