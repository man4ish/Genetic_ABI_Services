...
TableTitle_Tmp<-xmlValue(top[["SummaryIncreasedRiskTable"]][["Title"]])
...
Header1<-xmlValue(top[["SummaryIncreasedRiskTable"]][["Col1"]])
Header2<-xmlValue(top[["SummaryIncreasedRiskTable"]][["Col2"]])
Header3<-xmlValue(top[["SummaryIncreasedRiskTable"]][["Col3"]])
Header4<-xmlValue(top[["SummaryIncreasedRiskTable"]][["Col4"]])
Header5<-xmlValue(top[["SummaryIncreasedRiskTable"]][["Col5"]])
Header6<-xmlValue(top[["SummaryIncreasedRiskTable"]][["Col6"]])
...
if (runtype == 1)
{
    ...
    cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",Header1,"}} &\\textbf{ \\textcolor{white}{",Header2,"}} &\\textbf{ \\textcolor{white}{",Header3,"}}  &\\textbf{ \\textcolor{white}{",Header4,"}} &\\textbf{ \\textcolor{white}{",Header5,"}} &\\textbf{ \\textcolor{white}{",Header6,"}} \\\\",sep=""),"\n")
    cat("\\endfirsthead","\n")
...
cat("\\newcolumntype{M}[1]{>{\\centering\\arraybackslash}p{#1}}","\n")
TableTitle_Tmp<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Title"]])
TableTitle<-sub("\\$\\{cover_title\\}",CoverTitle,TableTitle_Tmp)
TableTitle<-sub("Report","",TableTitle)
...
Header1<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Col1"]])
Header2<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Col2"]])
Header3<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Col3"]])
Header4<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Col4"]])
Header5<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Col5"]])
Header6<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Col6"]])
...
cat("~\\\\","\n")
Caption<-xmlValue(top[["SummaryTypicalAndDecreasedRiskTable"]][["Caption"]])  
...
{
     cat("\\newcolumntype{M}[1]{>{\\centering\\arraybackslash}p{#1}}","\n")
     TableTitle_Tmp<-xmlValue(top[["SummaryDrugTable"]][["Title"]])
     TableTitle<-sub("\\$\\{cover_title\\}",CoverTitle,TableTitle_Tmp)
     TableTitle<-sub("Report","",TableTitle)
     ...
     cat("~\\\\","\n")
      ...
      DrugHeader1<-xmlValue(top[["SummaryDrugTable"]][["Col1"]])
      DrugHeader2<-xmlValue(top[["SummaryDrugTable"]][["Col2"]])
      DrugHeader3<-xmlValue(top[["SummaryDrugTable"]][["Col3"]])
      DrugHeader4<-xmlValue(top[["SummaryDrugTable"]][["Col4"]])
...
################################### Number of Risk Markers Detected ###################
     ...
     NumberOfRiskMarkers<-xmlValue(top[["Titles"]][["NumberOfRiskMarkers"]])             
     NumberOfRiskMarkers<-sub("\\$\\{your_risk_markers\\}",RiskMarkers,NumberOfRiskMarkers)
...
################################### Genetic Table ###################
     col1<-xmlValue(top[["GeneticTable"]][["Col1"]])
     col2<-xmlValue(top[["GeneticTable"]][["Col2"]])
     row1<-xmlValue(top[["GeneticTable"]][["Row1"]])
     row2<-xmlValue(top[["GeneticTable"]][["Row2"]])

     cat("\\scriptsize ","\n")
     cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{5.2cm}|M{3.2cm}|M{2.0cm}|}","\n")
     cat(paste("\\rowcolor{textcol} & \\textbf{ \\textcolor{white}{",col1,"}} & \\textbf{ \\textcolor{white}{",col2,"}} \\\\",sep=""),"\n")
     cat("\\hline","\n")
     cat(paste("\\rowcolor{rowcol} \\textbf{ \\textcolor{black}{",row1,"}} & & \\textbf{ \\textcolor{black}{",data[5,i],"}} \\\\",sep=""),"\n")
     cat("\\hline","\n")
     cat(paste("\\rowcolor{rowcol} \\textbf{ \\textcolor{black}{",row2,"}} & & \\\\",sep=""),"\n")
     cat("\\hline","\n")
     cat("\\end{longtable}}","\n")
...
################################### Risk Markers Table ###################   
     ...
     cat(paste("\\textcolor{black}{\\footnotesize \\textbf{",TableTitle,"}}",sep=""),"\n")
     cat("\\scriptsize ","\n")
     ...
     cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{1.4cm}|M{1.4cm}|M{1.4cm}|M{2.4cm}|M{.9cm}|M{1.6cm}|}","\n")
     cat("\\hline","\n")
     cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",head2,"}} &\\textbf{ \\textcolor{white}{",head3,"}} &\\textbf{ \\textcolor{white}{",head5,"}} &\\textbf{ \\textcolor{white}{",head4,"}} &\\textbf{ \\textcolor{white}{",head1,"}} &\\textbf{ \\textcolor{white}{",head7,"}} \\\\",sep=""),"\n")
     cat("\\endfirsthead","\n")
     cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",head2,"}} &\\textbf{ \\textcolor{white}{",head3,"}} &\\textbf{ \\textcolor{white}{",head5,"}} &\\textbf{ \\textcolor{white}{",head4,"}} &\\textbf{ \\textcolor{white}{",head1,"}} &\\textbf{ \\textcolor{white}{",head7,"}} \\\\",sep=""),"\n")
     ...
     if (rc > 0) {
         ...
         cat(paste("\\caption{\\textcolor{black}{\\scriptsize \\textit{",xmlValue(TableCaption),"}}}",sep=""),"\n")
         cat("\\end{longtable}}","\n")
     } 
...
################################### References ###################
     ...
     if (rc !=0 )
     {
         cat("~\\\\","\n")
         cat("\\needspace{1cm}","\n")
         cat(paste("\\footnotesize \\textcolor{black}{\\textbf{",title,"}}",sep=""),"\n")
     }
...
################################### Pharmacogenetic Markers Table ###################
       		...
       		cat(paste("\\textcolor{black}{\\textbf{",DrugTableTitle,"}}",sep=""),"\n")
                ...
                cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|M{1.5cm}|M{1.5cm}|M{3cm}|M{1.5cm}|M{2.0cm}|M{4.5cm}|}","\n")

                cat(paste("\\rowcolor{maincol} \\textbf{ \\textcolor{white}{",head2,"}} &\\textbf{ \\textcolor{white}{",head3,"}} &\\textbf{ \\textcolor{white}{",head4,"}} &\\textbf{ \\textcolor{white}{",head1,"}} &\\textbf{ \\textcolor{white}{",head5,"}}  \\\\",sep=""),"\n")
                cat("\\endfirsthead","\n")
