    ...
    if ((nrow(sorteddata) + nrow(sorteddata_trait))!= 0 )
    {
        ...
        {    
            ...
            if (lang == "en") {
                ...
                #cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.92cm}|M{1.7cm}|M{.75cm}|}","\n")
                cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3.2cm}|M{1.5cm}|M{.67cm}|}","\n")
            }
...
if (xmlSize(diseases) !=0)
{
    ...
    {       
         ...
         if (traitflag == 'N') {  
             ...
             if(GRR >= 2) {
                cat(paste("\\parbox[t][",totalwidth,"cm]{6.6cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\", Note1,"}}\\\\",sep=""),"\n")
             } else if(GRR > 1.0 && GRR <= 1.49) {
             cat(paste("\\parbox[t][",totalwidth,"cm]{6.6cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\",Note3,"}}\\\\",sep=""),"\n")
             }
             else if(GRR < 1.0) {
              
              cat(paste("\\parbox[t][",totalwidth,"cm]{6.6cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\",Note,"}}\\\\",sep=""),"\n")
             } 
             else {
               cat(paste("\\parbox[t][",totalwidth,"cm]{6.6cm}{\\textcolor{black}{","\\cellcolor{rowcol}","\\textbf{",GRR_Note ,"}. ~\\\\~\\\\",Note2,"}}\\\\",sep=""),"\n")
             }
...
################################### Disease's Prevention ###################
         ...
         #if (disid=="ONC_01_03") #|| disid=="ONC_01_30") 
         #{
         #    Text_Tmp<-""             
         #}   
