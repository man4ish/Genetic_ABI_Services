...
if (runtype == 1)
{
    ...
    for (rs in 1:rsize) {
         ...
         if (DiseaseID=="CRD_01_13") { SubType_Trait<-'Y' }         
    ...
    sorteddata_trait <- newdata_trait[order(newdata_trait$col4,decreasing = TRUE), ]
    ...
    if (nrow(sorteddata_trait) != 0 )
    {
        for (rs in 1:nrow(sorteddata_trait)) {
             ...
             #cat (paste("& N/A",sep=""),"\n")
             cat(paste("& ", sorteddata_trait[rs,4],sep=""),"\n")
             cat (paste("& ", " ",sep=""),"\n")
             cat (paste("& ", " ",sep=""),"\n")
             cat (paste("& ", " ",sep=""),"\n")
             #cat (paste("& N/A",sep=""),"\n")
