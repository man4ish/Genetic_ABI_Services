...
################################### Disease's Description ###################
         ...
         if (disid != "CRD_01_09" && disid != "CRD_01_13" && disid != "CRD_01_14") { 
             cat("~\\\\","\n") 
         }
...
################################### Disease's Symptoms ###################
         ...
         if (disid == "CRD_01_04" || disid == "CRD_01_05" || disid == "CRD_01_06") {
             cat("~\\\\[-5pt]","\n")
         } else { 
             cat("~\\\\","\n")
             cat("~\\\\","\n")
...
#cat("\\textit{\\textrm{Risk of developing a medical condition/trait by an individual with}} \\\\","\n")
#cat("\\frac{\\textit{\\textrm{particular genetic prediposing marker(s)}}}","\n")
#cat("{\\textit{\\textrm{Risk of developing a medical condition/trait by a general population}}}","\n")
...
#cat("\\begin{equation}","\n")
#cat("GRR = \\left.","\n")
#cat("\\begin{IEEEeqnarraybox}[l]{l?s}","\n")
#cat("\\textit{\\textrm{Risk of developing a medical condition/trait by an individual with}} \\\\","\n")
#cat("\\frac{\\textit{\\textrm{particular genetic pred}}}","\n")
#cat("{\\textit{\\textrm{Risk of developing a medical condition/trait by a general population}}}","\n")
#cat("\\end{IEEEeqnarraybox}","\n")
#cat("\\right.","\n")
#cat("\\end{equation}","\n")
