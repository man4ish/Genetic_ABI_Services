...
if (runtype == 1)
{
    ...
    if ((nrow(sorteddata) + nrow(sorteddata_trait))!= 0 )
    {
        ...
        if (lang == "en") {
            ...
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{3cm}|M{1.5cm}|M{.87cm}|}","\n")
        }
        ...
        if (nrow(data1) != 0 ){
            for (rs in 1:nrow(data1)) {      
                 ...
                 if (lang=="zh"||lang == "ch") {
                      disease_name<-data1[rs,1] 
                      if (ChipType == "CRD") {  
                          if (data1[rs,6]=="CRD_01_11"){
                              disease_name<-sub("\\(COPD\\)", "",disease_name) 
                          } else if (data1[rs,6]=="CRD_01_09"){
                              disease_name<-sub("\\(DVT\\)", "",disease_name)
                              disease_name<-sub("\\(PE\\)", "",disease_name) 
                          }  
                      } else if (ChipType == "ONC") {
                          if (data1[rs,6]=="ONC_01_08"){
                              disease_name<-sub("\\(ESCC\\)", "",disease_name) 
                          }
                      } 
                      cat(paste("\\parbox[t][",rowwidth1,"cm]{3.4cm}{\\raggedright ",disease_name,"} & ", data1[rs,4] ,"&",data1[rs,5]   ,"\\\\",sep=""),"\n")
                 } else { 
            ...
            if (nrow(data3) != 0 ) {
                if (tflag != 0) 
                {
                    for (rs in 1:nrow(data3)) {  
                         ...
                         if (lang=="zh"||lang == "ch")  {
                              disease_name<-data3[rs,1] 

                              if (ChipType == "CRD") {
                                  if (data3[rs,6]=="CRD_01_11"){
                                      disease_name<-sub("\\(COPD\\)", "",disease_name)
                                  } else if (data3[rs,6]=="CRD_01_09"){
                                      disease_name<-sub("\\(DVT\\)", "",disease_name)
                                      disease_name<-sub("\\(PE\\)", "",disease_name)
                                  }
                              } else if (ChipType == "ONC") {
                                  if (data3[rs,6]=="ONC_01_08"){
                                      disease_name<-sub("\\(ESCC\\)", "",disease_name)
                                  }
                              }

                              cat(paste("\\parbox[t][",rowwidth3,"cm]{3.4cm}{\\raggedright ",disease_name,"} & ", data3[rs,4] ,"&",data3[rs,5]   ,"\\\\",sep=""),"\n")
                         } else { 
                              cat(paste("\\parbox[t][",rowwidth3,"cm]{3.4cm}{\\raggedright ",data3[rs,1],"} & ", data3[rs,4] ,"&",data3[rs,5]   ,"\\\\",sep=""),"\n") 
                         }
         ...
         if (Text != ""){    
             ...
             if ((lang == "en") && (disid=="PDC_01_03" || disid=="CRD_01_05")) {
                 ...
                 if ((lang == "en") && ((disid=="ONC_01_03" && PatientGender == "M") || ( disid=="ONC_01_04" && PatientGender == "M") || 
                     ...
                     cat("\\newpage","\n")      
                 } else if ((lang=="zh"||lang == "ch") && (disid=="ONC_01_18")) {
                     cat("\\newpage","\n")
                 } else {
         ...
         if (ChipType == "CRD"){  
                 ...
                 disid=="ONC_01_24" || disid=="ONC_01_21" || disid=="ONC_01_27" || (disid=="ONC_01_28" && PatientGender=="F") || disid=="ONC_01_31")) 
             {
                 ...
                 cat("~\\\\[-3pt]","\n") 
                        ...
                        disid=="ONC_01_30" || disid == "ONC_01_24" || disid == "ONC_01_20" || disid == "ONC_01_23")){ 
                 cat("\\newpage","\n")
...
################################### Risk Markers Table ###################   
         ...
         if (ChipType == "CRD"){  
             ...
             if ((lang == "en") && (disid=="ONC_01_01" || disid=="ONC_01_14" || disid=="ONC_01_09"||disid=="ONC_01_13"||
                 ...
                 disid=="ONC_01_08" || disid=="ONC_01_15" || disid=="ONC_01_21" ||
                 disid=="ONC_01_12" || disid=="ONC_01_13" || disid=="ONC_01_19" || disid=="ONC_01_27" || disid=="ONC_01_29" || 
                 disid=="ONC_01_31" )){
                 cat("~\\newpage","\n")
...
#    if(rowwidth3 < 1) { rowwidth3<-1}
    ...
    if ((nrow(sorteddata) + nrow(sorteddata_trait))!= 0 )
    {
        ...
        if (lang == "en") {
            ...
            cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|p{2.8cm}|M{1.7cm}|M{.87cm}|}","\n")
        }   
        cat("\\hline","\n")    
        cat(paste("\\rowcolor{textcol} \\textbf{\\textcolor{white}{",TblIncreasedRisk_col1_title,"}}&\\textbf{\\textcolor{white}{",TblIncreasedRisk_col2_title,"}}&\\textbf{ \\textcolor{white}{",TblIncreasedRisk_col6_title,"}} \\\\",sep=""),"\n")
        cat("\\endfirsthead","\n")
...
if (runtype == 1)
{
  ...
  if(no_of_diseases > 10)
  {
    ...
    if (lang == "en") {
        ...
        cat(paste("\\rowcolor{textcol}\\textbf{\\textcolor{white}{",tblTypicalAndDecreasedRisk_col3_title,"}} \\\\[0.77cm]",sep=""),"\n")
        cat("\\endfirsthead","\n")
        cat(paste("\\rowcolor{textcol}\\textbf{\\textcolor{white}{",tblTypicalAndDecreasedRisk_col3_title,"}} \\\\[0.77cm]",sep=""),"\n")
        cat("\\endhead","\n")
    }
