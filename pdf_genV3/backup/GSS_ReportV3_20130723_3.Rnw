    ...
    if (nrow(sorteddata) != 0 )
    {
        ...
        for (rs in 1:nrow(sorteddata)) {
             ...
             if (R_Type == '1' ){#(as.numeric(as.character(sorteddata[rs,4])) > 2.00) {                                       
                 #cat(paste("& \\multirow{1}{*}{Type-1 Testing}",sep=""),"\n")  
                 #cat(paste("& ", " ",sep=""),"\n")
                 #cat(paste("& ", " ",sep=""),"\n")
                 #cat(paste("& ", sorteddata[rs,5]," \\\\",sep=""),"\n")
                 cat(paste(" & \\multirow{1}{*}{\\textcolor{black} \\scriptsize{Type-1 Testing}} &   &   & ",sorteddata[rs,5]," \\\\",sep=""),"\n")
                 R_Type<-'9' 
             } else if (R_Type == '2' ){                 
                 #cat(paste("& \\multirow{3}{*}{Type-2 Testing}",sep=""),"\n")      
                 #cat(paste("& ", " ",sep=""),"\n")
                 #cat(paste("& ", " ",sep=""),"\n")
                 #cat(paste("& ", sorteddata[rs,5]," \\\\ \\cline{1-2} \\cline{4-6}",sep=""),"\n")

                 cat(paste(" & \\multirow{3}{*}{\\textcolor{black} \\scriptsize{Type-2}} &   &   & ",sorteddata[rs,5]," \\\\ \\cline{1-2} \\cline{4-6}",sep=""),"\n")
                 R_Type<-'8' 
             } else {
                 #cat(paste("& ", " ",sep=""),"\n") 
                 #cat(paste("& ", " ",sep=""),"\n")
