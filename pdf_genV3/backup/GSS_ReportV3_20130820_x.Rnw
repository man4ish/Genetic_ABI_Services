...
if (runtype == 1)
{
    ...
    cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|M{2.7cm}|M{1.0cm}|M{2.4cm}|M{1.0cm}|M{1.3cm}|M{0.8cm}|}","\n")
    cat("\\hline","\n")
    ...
    if (nrow(sorteddata) != 0 )
    {
        ...
        for (rs in 1:nrow(sorteddata)) {
             ...
             #  else { 
                ...
                #if (R_Type == '9') { 
                #    if (Type2_cnt == 1) {cat("\\hline","\n")} 
                #    if (Type2_cnt == rcount_type2) { R_Type<-'2' }
             ...
             if (R_Type == '1' ){                                       
                 cat(paste(" & \\multirow{5}{2.4cm}{\\textcolor{black} \\tiny ",Note1,"}&", GLR,"\\% & ", AvGLR ,"\\% & ",sorteddata[rs,5]," \\\\",sep=""),"\n")
                 cat("  &  &  &  &  & \\\\","\n")
                 cat("  &  &  &  &  & \\\\","\n")
                 cat("  &  &  &  &  & \\\\","\n")
                 cat("  &  &  &  &  & \\\\","\n")
             ...
             # else if (R_Type == '9' ){    #2              
               #  if (Type2_cnt == 1) {
               #     cat(paste(" & \\multirow{8}{2.4cm}{\\textcolor{black} \\tiny ",Note2,"} &", GLR, "\\% & ",AvGLR ,"\\% & ",sorteddata[rs,5]," \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")        
               #  } else {            
             ...
             #else if (R_Type == '2' ){ 
               #  cat(paste(" & &", GLR,"\\% &", AvGLR,"\\% & ",sorteddata[rs,5]," \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")
               #  for (rsType2Cnt in Type2_cnt+1:8) { cat("  &  &  &  &  & \\\\","\n")}
               #  cat("\\hline","\n") 
             #}  
