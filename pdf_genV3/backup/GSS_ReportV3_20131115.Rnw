...
#}
         ...
         if (ChipType == "CRD"){  
                 ...
                 disid=="ONC_01_24" || disid=="ONC_01_21" || disid=="ONC_01_27" || (disid=="ONC_01_28" && PatientGender=="F") || disid=="ONC_01_31")) 
             {
                 ...
                 cat("\\newpage","\n")    
             } else if ((lang == "in") && (disid=="ONC_01_09" || disid == "ONC_01_26" || disid == "ONC_01_33")) {
                 cat("~\\\\[-3pt]","\n") 
             } else if ((lang == "in") && (disid=="ONC_01_13")) {
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
         ...
         if (ChipType == "CRD"){  
             if ((lang == "en") && (disid=="CRD_01_02" || disid=="CRD_01_03" || disid =="CRD_01_11" || 
                  ...
                  cat("\\newpage","\n")      
                         ...
                         (disid=="CRD_01_11" && RiskMarkers == "2")||(disid=="CRD_01_12" && RiskMarkers == "2"))) {
                  cat("\\newpage","\n")
             ...
             if ((lang == "en") && (disid=="ONC_01_01" || disid=="ONC_01_14" || disid=="ONC_01_09"||disid=="ONC_01_13"||
                 ...
                 (disid=="ONC_01_33" && PatientGender=="F"))){
                 cat("~\\newpage","\n")
                 ...
                 cat("~\\\\","\n")
                 cat("~\\\\[-21pt]","\n")
             } else if ((lang == "in") &&(disid=="ONC_01_14")){
                 cat("~\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
