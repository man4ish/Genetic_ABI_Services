...
GenGRRPlot <- function(IR,Gender,GRR, AvGRR, Interval, name, DiseaseID, age ) {              #new function added for plot generation
     ...
     if(ChipType == "CRD" || ChipType == "MTB")
     {
       ...
       maxGLR<-(maxGRR*(1-exp(-IR*80/10000)))*100
     }
     ...
     for ( i in 0:maxlimit)
     {
          ...
          if(t== 0) {
             ...
             if(ChipType == "CRD"|| ChipType == "MTB") {
                 ...
                 if(DiseaseID=="CRD_01_02" || DiseaseID=="CRD_01_04" ||DiseaseID=="CRD_01_09" ||DiseaseID=="CRD_01_11" ||DiseaseID=="CRD_01_12" ||DiseaseID=="CRD_01_14" ||DiseaseID=="MTB_01_01"||DiseaseID=="MTB_01_12"||DiseaseID=="MTB_01_04"||DiseaseID=="MTB_01_05"||DiseaseID=="MTB_01_09")
                 {
...
if (xmlSize(diseases) !=0)
{
    ...
    {       
         ...
         if (traitflag == 'N') {  
             ...
             if(ChipType == "CRD"|| ChipType == "MTB") {
                 if(disid=="CRD_01_02" || disid=="CRD_01_04" ||disid=="CRD_01_09" ||disid=="CRD_01_11" ||disid=="CRD_01_12" ||disid=="CRD_01_14" ||disid=="MTB_01_01"||disid=="MTB_01_12"||disid=="MTB_01_04"||disid=="MTB_01_05"||disid=="MTB_01_09")
                 {
