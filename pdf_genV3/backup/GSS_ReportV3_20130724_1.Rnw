...
if (runtype == 1)
{
    ...
    cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|P{2.5cm}|M{1.1cm}|P{1.4cm}|M{1.2cm}|M{2.1cm}|M{0.8cm}|}","\n")
    cat("\\hline","\n")
    ...
    if (nrow(sorteddata) != 0 )
    {
        ...
        for (rs in 1:nrow(sorteddata)) {
             ...
             if (R_Type == '1' ){#(as.numeric(as.character(sorteddata[rs,4])) > 2.00) {                                       
                 #cat(paste(" & \\multirow{1}{*}{\\textcolor{black} \\tiny Type-1 Testing} &   &   & ",sorteddata[rs,5]," \\\\",sep=""),"\n")
                 cat(paste(" & \\multirow{1}{*}{\\minitab[l]{\\textcolor{black} \\tiny Type-1\\\\Testing}} &   &   & ",sorteddata[rs,5]," \\\\",sep=""),"\n")
                 R_Type<-'9' 
             } else if (R_Type == '2' ){                 
                 cat(paste(" & \\multirow{3}[6]{*}{\\minitab[l]{\\textcolor{black} \\tiny Type-2\\\\Testing}} & - & - & ",sorteddata[rs,5],"\\bigstrut \\\\\\cline{1-2} \\cline{4-6}",sep=""),"\n")
                 ...
                 #cat(paste(" & & - & - & ",sorteddata[rs,5]," \\\\ \\cmidrule{1-2}\\cmidrule{4-6}",sep=""),"\n")
...
if (runtype == 1)
{
    ...
    cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|P{2.5cm}|M{1.1cm}|P{1.4cm}|M{1.2cm}|M{2.1cm}|M{0.8cm}|}","\n")
    cat("\\hline","\n")
...
if (runtype == 1)
{
    ...
    cat("{\\renewcommand{\\arraystretch}{1.5}\\begin{longtable}{|P{2.8cm}|M{1.1cm}|P{1.4cm}|M{1.2cm}|M{1.8cm}|M{0.8cm}|}","\n")
    cat("\\hline","\n")
    ...
    if (nrow(sorteddata) != 0 )
    {
        for (rs in 1:nrow(sorteddata)) {
             ...
             if (as.numeric(sorteddata[rs,4]) > 2) {
                cat("\\rowcolor[RGB]{243,189,185}","\n")   #{254,179,164},{253,162,137}                
             }
             else  {
                cat("\\rowcolor[RGB]{251,204,157}","\n")   # {249,177,105
...
if (runtype == 1)
{
    ...
    cat("{\\renewcommand{\\arraystretch}{1.8}\\begin{longtable}{|P{2.8cm}|M{1.1cm}|P{1.4cm}|M{1.2cm}|M{1.8cm}|M{0.8cm}|}","\n")
    cat("\\hline","\n")
    cat(paste("\\rowcolor{textcol} \\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col1_title,"}} &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col2_title,"}} &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col3_title,"}}  &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col4_title,"}} &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col5_title,"}} &\\textbf{ \\textcolor{white}{",tblTypicalAndDecreasedRisk_col6_title,"}} \\\\",sep=""),"\n")
    cat("\\endfirsthead","\n")
