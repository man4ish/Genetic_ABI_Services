...
GenGRRPlot <- function(IR,Gender,GRR, AvGRR, Interval, name, DiseaseID, age ) {              #new function added for plot generation
     ...
     if(ChipType == "CRD" || ChipType == "MTB" || ChipType == "OST"|| ChipType == "PDI" || ChipType == "PDC") {
     ...
     for ( i in 0:maxlimit)
     {
          ...
          if(t== 0) {
             ...
             if(ChipType == "CRD"|| ChipType == "MTB" || ChipType == "OST"|| ChipType == "PDI" || ChipType == "PDC") {
                 ...
                 if(DiseaseID=="CRD_01_02" || DiseaseID=="CRD_01_04" ||DiseaseID=="CRD_01_09" ||DiseaseID=="CRD_01_11" ||DiseaseID=="CRD_01_12" ||DiseaseID=="CRD_01_14" ||DiseaseID=="MTB_01_01"||DiseaseID=="MTB_01_12"||DiseaseID=="MTB_01_04"||DiseaseID=="MTB_01_05"||DiseaseID=="MTB_01_09" ||DiseaseID=="OST_01_07"||DiseaseID=="OST_01_08"||DiseaseID=="OST_01_09" ||DiseaseID=="PDC_01_02"||DiseaseID=="PDC_01_04"||DiseaseID=="PDC_01_07"||DiseaseID=="PDC_01_08"||DiseaseID=="PDC_01_09")
                 {
...
#    } else if (lang == "in") {
#        cat(paste("\\includegraphics[trim=0cm 0.cm 0cm 0cm, clip=true,width=",imagewidth,"\\linewidth]{",Section1,"}",sep=""),"\n")  
    } else {
...
if (runtype == 1)
{
    ...
    if (lang == "in"){
        if (rowwidth3 < 1.2) { rowwidth3<-1.2}
    } else {
...
if ((ChipType == "MTB" && (lang == "en" || lang == "in"))||(ChipType == "CRD" && lang == "in")) {
    cat("\\begin{center}","\n")
...
{
   #cat(paste("\\includegraphics[trim=0.23cm 0.25cm 0cm 0cm, clip=true,width=0.56\\linewidth]{",Section2,"}",sep=""),"\n")            
...
if (xmlSize(diseases) !=0)
{
    ...
    if(ChipType == "CRD" || ChipType == "MTB"|| ChipType == "PDC" || ChipType == "PDI"||ChipType == "OST")
    {
       maxrfile<-paste("Risk_Score/Dtect_",ChipType,".Max.xml",sep="")
       maxriskfile<-xmlParse(maxrfile)   
    }
    ...
    {       
         ...
         if (traitflag == 'N') {  
             ...
             if (ChipType == "CRD"|| ChipType == "MTB" || ChipType == "OST"|| ChipType == "PDI" || ChipType == "PDC") {
                 if(disid=="CRD_01_02" || disid=="CRD_01_04" ||disid=="CRD_01_09" ||disid=="CRD_01_11" ||disid=="CRD_01_12" ||disid=="CRD_01_14" ||disid=="MTB_01_01"||disid=="MTB_01_12"||disid=="MTB_01_04"||disid=="MTB_01_05"||disid=="MTB_01_09" || disid=="OST_01_07" ||disid=="OST_01_08" ||disid=="OST_01_09" ||disid=="PDC_01_02"||disid=="PDC_01_04"||disid=="PDC_01_07"||disid=="PDC_01_08"||disid=="PDC_01_09")
                 {
                    #cat(paste(name,GLR,AvGLR,maxGLR,maxGRR,IR,sep="\t"),file="tata",append=TRUE,"\n")    
             ...
             if (file.exists(ImageFile)) {
                 ...
                 if (lang == "in") {
                     cat(paste("\\includegraphics[trim=0.21cm 2.5cm 0cm 0.3cm, clip=true,width=0.909090909090909090\\linewidth]{",ImageFile,"}",sep=""),"\n")
                 } else {
         ...
         if (Text != ""){    
             ...
             if (ChipType == "CRD") {
                 ...
                 else if ((lang == "en") && (disid == "CRD_01_13")) { cat("~\\\\[-10pt]","\n") }  
                 else { cat("~\\\\","\n") }  
             }
                 ...
                 if (lang == "in" && disid == "ONC_01_22") {
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 } else if (lang == "in" && disid == "ONC_01_18"){        
                     cat("\\newpage","\n")
                 } else {      
             ...
             if ((lang == "en") && (disid=="PDC_01_03" || disid=="CRD_01_05")) {
                 cat("\\newpage","\n")
             } else if (ChipType == "ONC") {
                 if ((lang == "en") && ((disid=="ONC_01_03") || ( disid=="ONC_01_04" && PatientGender == "M") || 
                     disid=="ONC_01_05" || disid=="ONC_01_26"||disid=="ONC_01_22" || (disid=="ONC_01_28" && PatientGender =="M"))) {
                     cat("\\newpage","\n")      
                 } else if ((lang=="zh"||lang == "ch") && (disid=="ONC_01_18"|| (disid=="ONC_01_30" && PatientGender =="F"))) {
                     cat("\\newpage","\n")
                 } else if ((lang == "in") && (disid=="ONC_01_03" || disid=="ONC_01_20" || disid=="ONC_01_19" || disid=="ONC_01_15" |
                             disid=="ONC_01_25" || (disid=="ONC_01_28" && PatientGender == "F") || disid=="ONC_01_29" || disid=="ONC_01_32" || 
                             (disid=="ONC_01_04" && PatientGender == "F") || disid=="ONC_01_26" || (disid=="ONC_01_30" && PatientGender == "M") ||
                             disid=="ONC_01_34" )){
                     cat("\\newpage","\n")
                 } else {
                     if ((lang=="en"||lang=="in") && (disid=="ONC_01_07")) { cat("~\\\\","\n") } 
                     cat("~\\\\","\n")
                     cat("~\\\\","\n")
                 }   
             } else if ((lang == "en"||lang == "in") && (disid=="MTB_01_05")){
                 cat("~\\\\","\n")
                 cat("~\\\\[10pt]","\n")  
             } else if ((lang == "in") && (disid=="CRD_01_08" || disid=="CRD_01_06" || disid=="MTB_01_09")){ 
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\","\n")
         ...
         #if (disid=="ONC_01_16" || disid=="ONC_01_15") #disid=="ONC_01_18" || disid=="ONC_01_17" ) # || disid=="ONC_01_14" || disid=="ONC_01_13" || disid=="ONC_01_12" || disid=="ONC_01_11") 
         #{
         #    Text_Tmp<-""             
         #}   

         #if (disid != "ONC_01_14" && disid != "ONC_01_01" && disid != "ONC_01_02" && 
         #    ##disid != "ONC_01_03" #&& 
         #    disid != "ONC_01_04" && 
         #    disid != "ONC_01_15" && disid != "ONC_01_05" && disid != "ONC_01_06" && disid != "ONC_01_07" && 
         #    disid != "ONC_01_08" && disid != "ONC_01_20" && disid != "ONC_01_09"  && disid != "ONC_01_10" &&
         #    disid != "ONC_01_11" && disid != "ONC_01_21" && disid != "ONC_01_12" && disid != "ONC_01_13" && disid != "ONC_01_19" &&
         #    disid != "ONC_01_18" && disid != "ONC_01_23" && disid != "ONC_01_24" && disid != "ONC_01_25" && disid != "ONC_01_26" && 
         #    disid != "ONC_01_22" && disid != "ONC_01_27" && 
         #    disid != "ONC_01_28" && 
         #    disid != "ONC_01_29" && 
         #    ##disid != "ONC_01_30" && 
         #    disid != "ONC_01_31" && disid != "ONC_01_32" && disid != "ONC_01_33" && disid != "ONC_01_34"
         #    ) {
         #    Text_Tmp<-""    
         #    cat(paste("<",disid,">",sep=""),file="abc.xyz",append=TRUE,"\n")  
         #}


#if (disid=="ONC_01_30"){
#cat(paste("<",disid,">",Text_Tmp,sep=""),file="abc.xyz",append=TRUE,"\n")
#}
         ...
         if (ChipType == "CRD"){  
             ...
             if (lang == "en" && disid=="PDI_01_10") {
                 ...
                 cat("~\\\\[-15pt]","\n")
             } else if ((lang == "in") && (disid=="PDI_01_10")){
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\[-4pt]","\n")  
             }    
         } else if (ChipType == "PDC"){   
             if ((lang == "en") && (disid=="PDC_01_03" || disid=="PDC_01_04" || disid=="PDC_01_10")) {
                 cat("~\\\\[-4pt]","\n")
             } else if ((lang == "en") && (disid=="PDC_01_06" || disid=="PDC_01_07" || disid=="PDC_01_08")) {
                 cat("\\newpage","\n")
             ...
             if ((lang == "en") && (disid=="MTB_01_11" || disid=="MTB_01_08" || disid=="MTB_01_07")) {
                 cat("\\newpage","\n")               
             } else if ((lang == "en") && (disid=="MTB_01_02" || disid=="MTB_01_03")) {
                 cat("~\\\\[-4pt]","\n")
                 ...
                 cat("\\newpage","\n")
                        ...
                        disid=="MTB_01_08")){
                 cat("~\\\\[-4pt]","\n") 
             } else if ((lang == "in") && (disid=="MTB_01_13")) {
                 cat("\\newpage","\n")
             } else if ((lang == "in") && (disid=="MTB_01_02" || disid=="MTB_01_03" || disid=="MTB_01_12")) { 
                 cat("~\\\\[-4pt]","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
             ...
             if ((lang == "en") & (disid=="ONC_01_07" || disid=="ONC_01_02" || disid=="ONC_01_15" || (disid=="ONC_01_06" && PatientGender=="F")|| 
                 disid=="ONC_01_24" || disid=="ONC_01_21" || disid=="ONC_01_27" || (disid=="ONC_01_28" && PatientGender=="F") || disid=="ONC_01_31")) 
             {
                 cat("\\newpage","\n")
                 cat("~\\\\[-27pt]","\n")
             } else if ((lang == "en") && (disid=="ONC_01_09" || disid == "ONC_01_26" || disid == "ONC_01_33")) {
                 cat("~\\\\[-3pt]","\n") 
             } else if ((lang == "zh"||lang == "ch") && (disid=="ONC_01_03" || disid=="ONC_01_04" || disid=="ONC_01_05" ||  disid=="ONC_01_06" || 
                 ...
                 cat("\\newpage","\n")    
             } else if ((lang == "in") && (disid=="ONC_01_09" || disid == "ONC_01_26" || disid == "ONC_01_33"  && PatientGender=="F")) {
                 cat("~\\\\[-3pt]","\n") 
             } else if ((lang == "in") && (disid=="ONC_01_13" || (disid == "ONC_01_33" && PatientGender=="M"))) {
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\[-15pt]","\n")
             }
         ...
         if (ChipType == "CRD"){  
             if ((lang == "en") && (disid=="CRD_01_02" || disid=="CRD_01_03" || disid =="CRD_01_11" || 
                  disid =="CRD_01_12")){ 
                  cat("\\newpage","\n")                              
             } else if ((lang == "in") && (disid=="CRD_01_02" || disid =="CRD_01_11" || disid =="CRD_01_12")){
                  cat("\\newpage","\n")      
             ...
             if ((lang == "en") && (disid=="PDI_01_01" || disid=="PDI_01_05" || disid=="PDI_01_13" || (disid=="PDI_01_02" && RiskMarkers == 1) || 
                 (disid=="PDI_01_07" && RiskMarkers != "0"))){
                 cat("\\newpage","\n")               
             } else if (lang == "en" && disid=="PDI_01_04"){
                 cat("~\\\\[2pt]","\n")
                 ...
                 cat("\\newpage","\n") 
             } else if ((lang == "in") && (disid=="PDI_01_01" || (disid=="PDI_01_02" && RiskMarkers == 1) || disid=="PDI_01_04" ||
             ...
             if ((lang == "en") && (disid=="PDC_01_02" || disid=="PDC_01_04" || disid=="PDC_01_05" || disid=="PDC_01_10"|| 
                 disid=="PDC_01_09")){
                 cat("\\newpage","\n")
                 ...
                 cat("\\newpage","\n")
             } else if ((lang == "in") && (disid=="PDC_01_02" || disid=="PDC_01_04" || disid=="PDC_01_05" || disid=="PDC_01_07" || disid=="PDC_01_08")){
                 cat("\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
             ...
             if ((lang == "en") && ((disid=="MTB_01_01" && RiskMarkers != "0") || disid=="MTB_01_03" || 
                 disid=="MTB_01_04" || disid=="MTB_01_05" || disid=="MTB_01_10")){
                 cat("\\newpage","\n")
             ...
             } else if ((lang == "in") && (disid=="MTB_01_01" || disid=="MTB_01_03" || disid=="MTB_01_05" || disid=="MTB_01_10")){
                 cat("\\newpage","\n") 
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
             ...
             if ((lang == "en") && (disid=="ONC_01_01" || disid=="ONC_01_14" || disid=="ONC_01_09"||disid=="ONC_01_13"||
                 (disid=="ONC_01_33" && PatientGender=="M")|| (disid=="ONC_01_18" && RiskMarkers == 6))) {
                 cat("~\\newpage","\n")
             } else if ((lang == "en") &&(disid=="ONC_01_08")){
                 cat("~\\\\","\n")
                 cat("~\\\\[-21pt]","\n")
                 ...
                 disid=="ONC_01_27" || disid=="ONC_01_29" || disid=="ONC_01_31" || (disid=="ONC_01_28" && PatientGender=="F") || 
                 (disid=="ONC_01_33" && PatientGender=="F") || (disid=="ONC_01_33" && PatientGender=="M" && RiskMarkers == 2))){
                 cat("~\\newpage","\n")
             } else if ((lang == "zh"||lang == "ch") && (disid=="ONC_01_25" || disid=="ONC_01_22"|| disid=="ONC_01_26" || disid=="ONC_01_34" || disid=="ONC_01_10")){
                 cat("~\\\\","\n")
                 cat("~\\\\[-21pt]","\n")
             } else if ((lang == "in") &&(disid=="ONC_01_09")){
                 cat("~\\\\","\n")
                 cat("~\\\\[-21pt]","\n")
             } else if ((lang == "in") &&(disid=="ONC_01_14" || (disid=="ONC_01_18" && RiskMarkers == 6))){
                 cat("~\\newpage","\n")
             } else {
                 cat("~\\\\","\n")
                 cat("~\\\\[-7pt]","\n")
         ...
         if (rc !=0 )
         {
             if ((lang == "en") && (disid == "OST_01_13" || disid == "OST_01_08")) {
                cat("\\newpage","\n") 
             } else if ((lang == "en") && (disid == "ONC_01_18" && RiskMarkers == 7)) {
                cat("\\newpage","\n")            
             } else if ((lang == "zh" || lang == "ch") && ((disid == "PDI_01_06" && RiskMarkers == "1") ||
                        (disid == "PDI_01_07" && RiskMarkers == "1") || disid == "PDI_01_09")){
                cat("\\newpage","\n")   
             } else if ((lang == "in") && ((disid == "ONC_01_18" && RiskMarkers < 6) || 
                        (disid == "ONC_01_30" && PatientGender=="F" && RiskMarkers > 6))) {
                cat("\\newpage","\n")  
	     } else if ((lang == "in") && (disid == "PDC_01_06" && RiskMarkers == 7)) {
                cat("\\newpage","\n")
             } else {
                cat("\\vspace{-0.1cm}","\n")
             }       
...
if (runtype == 1)
{
    ...
    if (nrow(data3) < 12) {         
        ...
        else { rowwidth3<-as.numeric(round(4.5/nrow(data3),3)) }
...
if (runtype == 1)
{
    ...
    if (ChipType == "CRD"){ 
        ...
        if (lang == "en"){  
            totalwidth<-typicalsortedrowwidth*maxrows + 0.2733*(maxrows-1) #0.2694
        } else if (lang == "in") {  
