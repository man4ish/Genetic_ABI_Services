...
${OBJECTDIR}/SqlQryBuf.o: SqlQryBuf.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/SqlQryBuf.o SqlQryBuf.cpp

${OBJECTDIR}/DbBase.o: DbBase.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -I/usr/include/mysql -MMD -MP -MF $@.d -o ${OBJECTDIR}/DbBase.o DbBase.cpp
