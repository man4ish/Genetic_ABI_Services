        ...
        const string& _lang_code)
{
    ...
    string summ_incr_risk_title, summ_incr_risk_col1, summ_incr_risk_col2, summ_incr_risk_col3, summ_incr_risk_col4, summ_incr_risk_col5, summ_incr_risk_col6,
           summ_incr_risk_note1, summ_incr_risk_note2, summ_incr_risk_note3, summ_incr_risk_dr_note1, summ_incr_risk_dr_note2, summ_incr_risk_dr_note3;
    ...
    xml_ret = gss_xml_writer.insert_summ_increased_risk(
            ...
            summ_incr_risk_note2.c_str(), summ_incr_risk_note3.c_str(), summ_incr_risk_dr_note1.c_str(), 
            summ_incr_risk_dr_note2.c_str(), summ_incr_risk_dr_note3.c_str());
    ...
    string genetic_col1, genetic_col2, genetic_col3, genetic_row1, genetic_row2;
    ...
    xml_ret = gss_xml_writer.insert_graph_writeup(writeup.c_str());
