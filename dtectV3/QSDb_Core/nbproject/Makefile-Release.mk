...
${OBJECTDIR}/QSDb_Public.o: QSDb_Public.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -Werror -I../GSSDb_Core -I/usr/include/mysql -I../DbBase -MMD -MP -MF $@.d -o ${OBJECTDIR}/QSDb_Public.o QSDb_Public.cpp

${OBJECTDIR}/QSDb_Private.o: QSDb_Private.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -Werror -I../GSSDb_Core -I/usr/include/mysql -I../DbBase -MMD -MP -MF $@.d -o ${OBJECTDIR}/QSDb_Private.o QSDb_Private.cpp

${OBJECTDIR}/QSDb_Map.o: QSDb_Map.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -Werror -I../GSSDb_Core -I/usr/include/mysql -I../DbBase -MMD -MP -MF $@.d -o ${OBJECTDIR}/QSDb_Map.o QSDb_Map.cpp
