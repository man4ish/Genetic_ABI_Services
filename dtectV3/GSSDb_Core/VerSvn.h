 ...
 * initial set to "$Revision: 7790 $" and "$HeadURL: svn+ssh://syhwah@192.168.1.9/svn/repos/synamatix/gss/trunk/dtect/GSSDb_Core/VerSvn.h $"
 */
...
#define URL "$HeadURL: svn+ssh://syhwah@192.168.1.9/svn/repos/synamatix/gss/trunk/dtect/GSSDb_Core/VerSvn.h $"
