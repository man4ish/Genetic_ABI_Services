...
${OBJECTDIR}/GSSDb_Search.o: GSSDb_Search.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -I/usr/include/mysql -I../DbBase -MMD -MP -MF $@.d -o ${OBJECTDIR}/GSSDb_Search.o GSSDb_Search.cpp

${OBJECTDIR}/GSSDb_Public.o: GSSDb_Public.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -I/usr/include/mysql -I../DbBase -MMD -MP -MF $@.d -o ${OBJECTDIR}/GSSDb_Public.o GSSDb_Public.cpp

${OBJECTDIR}/VerSvn.o: VerSvn.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -I/usr/include/mysql -I../DbBase -MMD -MP -MF $@.d -o ${OBJECTDIR}/VerSvn.o VerSvn.cpp

${OBJECTDIR}/GSSDb_Private.o: GSSDb_Private.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -I/usr/include/mysql -I../DbBase -MMD -MP -MF $@.d -o ${OBJECTDIR}/GSSDb_Private.o GSSDb_Private.cpp
