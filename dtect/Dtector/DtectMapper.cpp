...
bool DtectMapper::generate_qr_code()
{
    ...
    if (this->patient_name == "anonymous")
        ...
        sprintf(qrcode_string, "%s%s/%s/%04d-%02d-%02d",
            this->chip_type.c_str(),
            this->chip_ver.c_str(),
            this->sample_id.c_str(),
            this->order_rcvd_date.year(),
        ...
        const string& _lang_code)
{
    ...
    xml_ret = gss_xml_writer.insert_general_information(
            ...
            this->InterpretResult.c_str(),
            cover_title.c_str(), //syhwah 2013-03-13 :- added this->InterpretResult
            this->chip_type.c_str(), //wuntyng 2013-03-27
            this->partner_code.c_str(), //syhwah 2013-04-17
            label_your_drug_profile.c_str()); //syhwah 2013-04-21
    ...
    string box_plot_caption, box_plot_title, box_plot_subtitle, drug_title,
            legend_increased_risk, legend_normal_risk, legend_reduced_risk, legend_your_position,
            table_caption, table_title, drug_table_title,
            overall_relative_risk_typical, overall_relative_risk_slightly, overall_relative_risk_increased,
            overall_relative_risk, overall_risk_marker, overall_typical_risk;
    
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_caption", box_plot_caption);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_title", box_plot_title);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "title_box_plot", box_plot_subtitle);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "drug_title", drug_title);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "legend_increased_risk", legend_increased_risk);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "legend_normal_risk", legend_normal_risk);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "legend_reduced_risk", legend_reduced_risk);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "legend_your_position", legend_your_position);
    assert(ret == true);
    ...
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "table_title", table_title);
    assert(ret == true);
    ...
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "overall_relative_risk_typical", overall_relative_risk_typical);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "overall_relative_risk_slightly", overall_relative_risk_slightly);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "overall_relative_risk_increased", overall_relative_risk_increased);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "overall_relative_risk", overall_relative_risk);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "overall_risk_marker", overall_risk_marker);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "overall_typical_risk", overall_typical_risk);
    assert(ret == true);

    xml_ret = gss_xml_writer.insert_titles(
            box_plot_caption.c_str(),
            box_plot_title.c_str(),
            box_plot_subtitle.c_str(),
            drug_title.c_str(),
            legend_increased_risk.c_str(),
            legend_normal_risk.c_str(),
            legend_reduced_risk.c_str(),
            legend_your_position.c_str(),
            table_caption.c_str(),
            overall_relative_risk_typical.c_str(),
            overall_relative_risk_slightly.c_str(),
            overall_relative_risk_increased.c_str(),
            table_title.c_str(),
            drug_table_title.c_str(),
            overall_relative_risk.c_str(),
            overall_risk_marker.c_str(),
            overall_typical_risk.c_str());
    ...
    string term_title, term_content_1, term_content_2, term_content_3, term_content_4, term_content_5;
    ...
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "contents_terms_1", term_content_1);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "contents_terms_2", term_content_2);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "contents_terms_3", term_content_3);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "contents_terms_4", term_content_4);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "contents_terms_5", term_content_5);
    assert(ret == true);
    
    xml_ret = gss_xml_writer.insert_term(
            term_title.c_str(),
            term_content_1.c_str(),
            term_content_2.c_str(),
            term_content_3.c_str(),
            term_content_4.c_str(),
            term_content_5.c_str());
    assert(xml_ret == true);
    ...
    string genetic_summary, comparative_risk, summary_title, pop_zero_note, pat_zero_note, und_note, pat_legend, pop_legend, disclaimer, axis,
            risk_footnote1, risk_footnote2, risk_footnote3,
            table_risk_description, genetic_summary_title, genetic_h_1, genetic_h_2, genetic_h_3, genetic_h_4, genetic_h_5, summary_no_risk, genetic_caption, genetic_content,
            drug_summary_title, drug_h_1, drug_h_2, drug_h_3, drug_h_4, drug_caption,
            box_plot_interpretation_upper, box_plot_interpretation_lower, box_plot_interpretation_footnote,
            box_plot_interpretation_1_1, box_plot_interpretation_1_2, box_plot_interpretation_2_1, box_plot_interpretation_2_2, box_plot_interpretation_3_1, box_plot_interpretation_3_2;
    
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "your_genetic_summary", genetic_summary);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "your_comparative_risk", comparative_risk);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "dtect_summary", summary_title);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_upper", box_plot_interpretation_upper);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_1_1", box_plot_interpretation_1_1);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_1_2", box_plot_interpretation_1_2);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_2_1", box_plot_interpretation_2_1);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_2_2", box_plot_interpretation_2_2);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_3_1", box_plot_interpretation_3_1);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_3_2", box_plot_interpretation_3_2);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_lower", box_plot_interpretation_lower);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "box_plot_interpretation_footnote", box_plot_interpretation_footnote);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "summ_footnote_gen_pop_zero", pop_zero_note);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "summ_footnote_patient_zero", pat_zero_note);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "summ_footnote_und", und_note);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "risk_footnote1", risk_footnote1);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "risk_footnote2", risk_footnote2);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "risk_footnote3", risk_footnote3);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "patient", pat_legend);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "gen_pop", pop_legend);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "disclaimer", disclaimer);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "summ_axis", axis);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "increased_risk_title", genetic_summary_title);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "risk_table_desc", table_risk_description);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "risk_table_col1", genetic_h_1);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "risk_table_col2", genetic_h_2);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "risk_table_col3", genetic_h_3);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "risk_table_col4", genetic_h_4);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "TITLE", "risk_table_col5", genetic_h_5);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "summary_no_risk", summary_no_risk);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "risk_perc", genetic_caption);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "relative_risk_interpretation", genetic_content);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "title_pharmacogenetic_summary", drug_summary_title);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "table1_pharmacogenetic_summary", drug_h_1);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "table2_pharmacogenetic_summary", drug_h_2);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "table3_pharmacogenetic_summary", drug_h_3);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "table4_pharmacogenetic_summary", drug_h_4);
    assert(ret == true);
    ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "content_pharmacogenetic_summary", drug_caption);
    assert(ret == true);
    
    xml_ret = gss_xml_writer.insert_summary(
            genetic_summary.c_str(),
            comparative_risk.c_str(),
            box_plot_interpretation_upper.c_str(),
            box_plot_interpretation_1_1.c_str(),
            box_plot_interpretation_1_2.c_str(),
            box_plot_interpretation_2_1.c_str(),
            box_plot_interpretation_2_2.c_str(),
            box_plot_interpretation_3_1.c_str(),
            box_plot_interpretation_3_2.c_str(),
            box_plot_interpretation_lower.c_str(),
            box_plot_interpretation_footnote.c_str(),
            summary_title.c_str(),
            pop_zero_note.c_str(),
            pat_zero_note.c_str(),
            und_note.c_str(),
            risk_footnote1.c_str(),
            risk_footnote2.c_str(),
            risk_footnote3.c_str(),
            pat_legend.c_str(),
            pop_legend.c_str(),
            disclaimer.c_str(),
            axis.c_str(),
            table_risk_description.c_str(),
            genetic_summary_title.c_str(),
            genetic_h_1.c_str(),
            genetic_h_2.c_str(),
            genetic_h_3.c_str(),
            genetic_h_4.c_str(),
            genetic_h_5.c_str(),
            summary_no_risk.c_str(),
            genetic_caption.c_str(),
            genetic_content.c_str(),
            drug_summary_title.c_str(),
            drug_h_1.c_str(),
            drug_h_2.c_str(),
            drug_h_3.c_str(),
            drug_h_4.c_str(),
    ...
    {
        double relative_risk, Incidence; //syhwah 2013-04-02 : added Incidence
        int positive_markers, neutral_markers, negative_markers;
        char sex = 'B', trait = 'N';

        //syhwah 2013-04-02 : added Incidence, 2013-04-02 : added trait
        ...
        /*         
        switch (sex){ //syhwah 2013-04-02
          case 'M': { sprintf(acIncidence,"%.2f (Male)",Incidence);  break; }
          case 'F': { sprintf(acIncidence,"%.2f (Female)",Incidence);  break; }
          case 'B': { sprintf(acIncidence,"%.2f",Incidence);  break; }
        }  
        */


        switch (sex){ //syhwah 2013-06-12
          case 'M':
          case 'F':
          {
        ...
        string geno_effect_hdr, hdr_gene, hdr_snp, hdr_alleles, hdr_effect, hdr_ref, footnote;
        string hdr_risk_allele, hdr_relative_risk;
        ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "genotype_title", geno_effect_hdr);
        assert(ret == true);
        ...
        assert(ret == true);
        ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "genotype_table_footnote", footnote);
        assert(ret == true);
        ...
        xml_ret = gss_xml_writer.insert_geno_effects_hdr(
                geno_effect_hdr.c_str(),
                hdr_gene.c_str(),
                hdr_snp.c_str(),
                hdr_alleles.c_str(),
                hdr_effect.c_str(),
        ...
        //VarDb var_db("VarDb", "192.168.7.4", "manish", "");
        //VarDb var_db("VarDb", "192.168.7.1", "jameswong", ""); //syhwah 2013-03-11
        ...
        assert(ret == true);
        xml_ret = gss_xml_writer.insert_novariant(no_variant.c_str());
        assert(xml_ret == true);
        ...
        string description;
        if ((sex == 'B') || (sex == this->gender.c_str()[0]))
            ret = trans_db.get_content(this->trans_conf.get_doc_id(this->testcode, "desc"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), "DESC", dis_drug_id.c_str(), description);
        else
        {
            char gender_text_id[32] = {0};
            sprintf(gender_text_id, "%s_%s", dis_drug_id.c_str(), this->gender.c_str());
            ret = trans_db.get_content(this->trans_conf.get_doc_id(this->testcode, "desc"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), "DESC", gender_text_id, description);
            if (ret == false)
            {
                this->gss_logger->log(true, "%s for %s not available\n", dis_drug_id.c_str(), this->gender.c_str());
                ret = trans_db.get_content(this->trans_conf.get_doc_id(this->testcode, "desc"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), "DESC", dis_drug_id.c_str(), description);
            }
        }
        assert(ret == true);

        xml_ret = gss_xml_writer.insert_description(dis_drug_name.c_str(), description.c_str());
        assert(xml_ret == true);

        xml_ret = gss_xml_writer.insert_references(hdr_ref.c_str());
        assert(xml_ret == true);
        ...
        assert(ret == true);
        xml_ret = gss_xml_writer.insert_nocitation(no_citation.c_str());
        assert(xml_ret == true);

        xml_ret = gss_xml_writer.append_references();
        assert(xml_ret == true);
        
        xml_ret = this->process_ext_content(gss_xml_writer, _lang_code, dis_drug_id, "Definition");
        assert(xml_ret == true);
        xml_ret = this->process_ext_content(gss_xml_writer, _lang_code, dis_drug_id, "Causes");
        assert(xml_ret == true);
        xml_ret = this->process_ext_content(gss_xml_writer, _lang_code, dis_drug_id, "Symptoms");
        assert(xml_ret == true);
        xml_ret = this->process_ext_content(gss_xml_writer, _lang_code, dis_drug_id, "Risk");
        assert(xml_ret == true);
        xml_ret = this->process_ext_content(gss_xml_writer, _lang_code, dis_drug_id, "Complications");
        assert(xml_ret == true);
        xml_ret = this->process_ext_content(gss_xml_writer, _lang_code, dis_drug_id, "Lifestyle");
        assert(xml_ret == true);

        xml_ret = gss_xml_writer.append_ext_content();
        assert(xml_ret == true);


        if ((type == "Disease") || (type == "Trait"))
        {
            string disease_plot_title;
            string profile_title;
            ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "distribution", disease_plot_title);
            assert(ret == true);
            ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "profile_disease_title", profile_title);
            assert(ret == true);

            char logo_risk[2048] = {0};
            sprintf(logo_risk, "%s%s", this->gss_config.get_image_dir(), "logo_profile_disease.png");
            char logo_question[2048] = {0};
            sprintf(logo_question, "%s%s", this->gss_config.get_image_dir(), "logo_des_disease.png");
            char logo_reference[2048] = {0};
            sprintf(logo_reference, "%s%s", this->gss_config.get_image_dir(), "logo_ref_disease.png");

            xml_ret = gss_xml_writer.append_disease(
                    disease_plot_title.c_str(),
                    profile_title.c_str(),
                    logo_risk,
                    logo_question,
                    logo_reference);
        ...
        {
            string profile_title;
            ret = trans_db.get_content(this->trans_conf.get_doc_id("label"), _lang_code.c_str(), this->trans_conf.get_version("label"), "LABEL", "profile_drug_title", profile_title);
            assert(ret == true);

            char logo_drug[2048] = {0};
            sprintf(logo_drug, "%s%s", this->gss_config.get_image_dir(), "logo_drug.png");
            char logo_question[2048] = {0};
            sprintf(logo_question, "%s%s", this->gss_config.get_image_dir(), "logo_des_drug.png");
            char logo_reference[2048] = {0};
            sprintf(logo_reference, "%s%s", this->gss_config.get_image_dir(), "logo_ref_drug.png");
...
bool DtectMapper::process_ext_content(
        ...
        const char* _section)
{
    ...
    char text_id[1024] = {0};
    char img_full_path[1024] = {0};
    string title, text, img, cap, source;
    ...
    ret = trans_db.get_content(false, this->trans_conf.get_doc_id(this->testcode, "ec"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), text_type, _dis_drug_id.c_str(), text, source);
    assert(ret == true);
    sprintf(text_type, "%s_IMG", section_id_upper);
    ret = trans_db.get_content(false, this->trans_conf.get_doc_id(this->testcode, "ec"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), text_type, _dis_drug_id.c_str(), img, source);
    assert(ret == true);
    sprintf(text_type, "%s_CAP", section_id_upper);
    ret = trans_db.get_content(false, this->trans_conf.get_doc_id(this->testcode, "ec"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), text_type, _dis_drug_id.c_str(), cap, source);
    assert(ret == true);

    img_full_path[0] = '\0';
    if (img.length() > 3)
        sprintf(img_full_path, "%smayo_clinic%s", this->gss_config.get_image_dir(), img.c_str());
    if (source == "MC")
    {
        char logo_path[1024] = {0};
        sprintf(logo_path, "%smayo_clinic/MC.jpg", this->gss_config.get_image_dir());
        return _gss_xml_writer.insert_ext_content(logo_path, _section, title.c_str(), img_full_path, cap.c_str(), text.c_str());
    }
    else
        return _gss_xml_writer.insert_ext_content(NULL, _section, title.c_str(), img_full_path, cap.c_str(), text.c_str());
}


bool DtectMapper::process_ext_content_multi( //syhwah 2013-03-20 :- might be used in future
        GssXmlWriter& _gss_xml_writer,
        const string& _lang_code,
        const string& _dis_drug_id,
        const char* _section)
{
    ...
    ret = trans_db.get_content(false, this->trans_conf.get_doc_id(this->testcode, "ec"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), text_type, _dis_drug_id.c_str(), text, source);
    assert(ret == true);
    sprintf(text_type, "%s_IMG_T", section_id_upper);
    ret = trans_db.get_content_multi(false, this->trans_conf.get_doc_id(this->testcode, "ec"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), text_type, _dis_drug_id.c_str(), img_set, source);
    assert(ret == true);
    sprintf(text_type, "%s_CAP_T", section_id_upper);
    ret = trans_db.get_content_multi(false, this->trans_conf.get_doc_id(this->testcode, "ec"), _lang_code.c_str(), this->trans_conf.get_version(this->testcode), text_type, _dis_drug_id.c_str(), cap_set, source);
    assert(ret == true);
    if (source == "MC"){
        char logo_path[1024] = {0};
        sprintf(logo_path, "%smayo_clinic/MC.jpg", this->gss_config.get_image_dir());

        return _gss_xml_writer.insert_ext_content_multi(logo_path, _section, title.c_str(), this->gss_config.get_image_dir(), img_set, cap_set, text.c_str());
    }
    else{        
        return _gss_xml_writer.insert_ext_content_multi(NULL, _section, title.c_str(), this->gss_config.get_image_dir(), img_set, cap_set, text.c_str());
    }
}
...
bool DtectMapper::generate_pdf(const string& _lang_code) const //syhwah 2013-03-15 :- added _lang_code
{
    ...
    // NOTE: R/LaTeX script 'run_generate_gss_report_xml.sh' is for GenOne report
    // Depending on setting in TransConfig, a different script may be called for GenTwo (or later) report format
    ...
    if (_lang_code == "en" && this->InterpretResult=="1") { nInterpretRpt=1; } //syhwah 2013-03-15
    ...
    if (latex_log_file != NULL)
        //sprintf(pdf_gen_command, "/opt/synamatix/gss/bin/pdf_gen/run_generate_gss_report_xml.sh %s %d >> %s 2>> %s",
        sprintf(pdf_gen_command, "%s %s%s%d >> %s 2>> %s",
                acLaTeX,        //syhwah 2013-04-23
                this->xml_output_filename.c_str(),
                acParam,        //syhwah 2013-04-23  
                nInterpretRpt,  //syhwah 2013-03-15
                latex_log_file,
                latex_log_file);
    else
        //sprintf(pdf_gen_command, "/opt/synamatix/gss/bin/pdf_gen/run_generate_gss_report_xml.sh %s %d",
        sprintf(pdf_gen_command, "%s %s%s%d",
                acLaTeX,       //syhwah 2013-04-23               
                this->xml_output_filename.c_str(),
                acParam,       //syhwah 2013-04-23 
                nInterpretRpt  //syhwah 2013-03-15
