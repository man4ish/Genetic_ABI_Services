        ...
        const char* _term_content_5)
{
    ...
    DOMElement *term_content_1_elem = this->createElement("TermsContent1", _term_content_1);
    if (term_content_1_elem == NULL) return false;
    if (term_elem->appendChild(term_content_1_elem) == NULL) return false;
    
    DOMElement *term_content_2_elem = this->createElement("TermsContent2", _term_content_2);
    if (term_content_2_elem == NULL) return false;
    if (term_elem->appendChild(term_content_2_elem) == NULL) return false;
    
    DOMElement *term_content_3_elem = this->createElement("TermsContent3", _term_content_3);
    if (term_content_3_elem == NULL) return false;
    if (term_elem->appendChild(term_content_3_elem) == NULL) return false;
    
    DOMElement *term_content_4_elem = this->createElement("TermsContent4", _term_content_4);
    if (term_content_4_elem == NULL) return false;
    if (term_elem->appendChild(term_content_4_elem) == NULL) return false;
    
    DOMElement *term_content_5_elem = this->createElement("TermsContent5", _term_content_5);
    if (term_content_5_elem == NULL) return false;
    if (term_elem->appendChild(term_content_5_elem) == NULL) return false;
        ...
        const char* _drug_caption)
{
    ...
    DOMElement *genetic_header_elem = this->createElement("GeneticHeader");
    ...
    if (this->summ_elem->appendChild(genetic_header_elem) == NULL) return false;
