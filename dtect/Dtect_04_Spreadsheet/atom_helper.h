...
namespace gdata
{
    ...
    public:
        ...
        void Parse(const string& xml_str);
        ...
        string CellFeed(const Node *entry) const;
        string Content(const Node *entry) const;
        ...
        string Updated(const Node *entry) const;
        string RowCount(const Node *entry) const;
        string ColCount(const Node *entry) const;
        string Lang(const Node *entry, string lang) const;
        string Author(const Node *entry) const;
        string AuthorEmail(const Node *entry) const;
