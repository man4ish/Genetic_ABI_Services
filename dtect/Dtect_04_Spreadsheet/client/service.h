...
namespace gdata
{
    namespace client
    {
        ...
        const string kClientLoginUrl = "https://www.google.com/accounts/ClientLogin";
        const string kClientLoginAuthHeaderPrefix = "Authorization: GoogleLogin auth=";
        ...
        public:
            ...
            void set_request_headers(const vector<string>& headers) {request_headers_ = headers; }
